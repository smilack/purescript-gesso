...
(function($PS) {
  "use strict";
  $PS["Example.Hello.Main"] = $PS["Example.Hello.Main"] || {};
  var exports = $PS["Example.Hello.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  ...
  var render = function (v) {
      return function (v1) {
          return function (v2) {
              return function (context) {
                  return Graphics_Canvas.fillText(context)("hello world")(500.0)(500.0);
              };
          };
      };
  };
