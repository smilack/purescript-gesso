...
(() => {
            ...
            eqRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  var get5 = unsafeGet(key3);
                  return eq34(get5(ra))(get5(rb)) && tail3;
                };
              };
            }
          };
  ...
  var foldableNonEmpty = function(dictFoldable) {
    ...
    return {
      foldMap: function(dictMonoid) {
        ...
        return function(f) {
          return function(v) {
            return append16(f(v.value0))(foldMap13(f)(v.value1));
          };
        };
      },
      foldl: function(f) {
  ...
  var OrdBox = /* @__PURE__ */ function() {
    function OrdBox2(value0, value15, value22) {
      this.value0 = value0;
      this.value1 = value15;
      this.value2 = value22;
    }
    ...
    OrdBox2.create = function(value0) {
      return function(value15) {
        return function(value22) {
          return new OrdBox2(value0, value15, value22);
        };
      };
    };
    return OrdBox2;
  ...
  var ChildQuery = /* @__PURE__ */ function() {
    function ChildQuery3(value0, value15, value22) {
      this.value0 = value0;
      this.value1 = value15;
      this.value2 = value22;
    }
    ...
    ChildQuery3.create = function(value0) {
      return function(value15) {
        return function(value22) {
          return new ChildQuery3(value0, value15, value22);
        };
      };
    };
    return ChildQuery3;
  ...
  var render = function(v) {
    ...
    }), style3("background-color: " + (v.color + ";") + ("width: 72px;" + ("height: 72px;" + ("margin: 6px 12px;" + ("cursor: pointer;" + selectedStyle)))))])([]);
  };
  ...
  var component = /* @__PURE__ */ function() {
    return mkComponent({
      ...
      "eval": mkEval({
        ...
        handleAction,
        receive: function($16) {
          return Just.create(Update.create($16));
        }
      })
    });
  }();
    ...
    append: function(v) {
      return function(v1) {
        ...
        if (v instanceof Plain && v1 instanceof Prefixed) {
          return new Prefixed(map10(second2(function(v2) {
            return v.value0 + v2;
          }))(v1.value0));
        }
        ;
  ...
  var plain = function(v) {
    if (v instanceof Prefixed) {
      return fromMaybe("")(lookup7("")(v.value0));
    }
    ;
  ...
  var px = function(i2) {
    return new BasicSize(append6(value3(i2))(fromString3("px")));
  };
  var pct = function(i2) {
    return new BasicSize(append6(value3(i2))(fromString3("%")));
  };
  ...
  var $$with = function(v) {
    return function(v1) {
      return new Selector(append7(v.value0)(v1), v.value1);
    };
  };
  var star = /* @__PURE__ */ function() {
  ...
  var bind3 = /* @__PURE__ */ bind(/* @__PURE__ */ bindWriterT(semigroupArray)(bindIdentity));
  ...
  var key = function(dictVal) {
    ...
    return function(k) {
      return function(v) {
        return rule(new Property2(cast(k), value15(v)));
      };
    };
  };
  var functorStyleM = {
  ...
  var width3 = /* @__PURE__ */ key2(/* @__PURE__ */ fromString4("width"));
  var top3 = /* @__PURE__ */ key2(/* @__PURE__ */ fromString4("top"));
  var left = /* @__PURE__ */ key2(/* @__PURE__ */ fromString4("left"));
  var height3 = /* @__PURE__ */ key2(/* @__PURE__ */ fromString4("height"));
  ...
  // output/Gesso.Scale/index.js
  var fromFoldable4 = /* @__PURE__ */ fromFoldable2(ordString)(foldableArray);
  var toMap = function(v) {
    return fromFoldable4([new Tuple("x", v.x), new Tuple("x1", v.x), new Tuple("x2", v.x), new Tuple("y", v.y), new Tuple("y1", v.y), new Tuple("y2", v.y), new Tuple("width", v.width), new Tuple("w", v.width), new Tuple("height", v.height), new Tuple("h", v.height), new Tuple("radius", v.width), new Tuple("r", v.width)]);
  };
  var scale = function(dict) {
    return dict.scale;
  };
  var mkScaler = function(rect2) {
    return function(fns) {
      var all4 = function() {
        return function(dictScalable) {
          return scale(dictScalable)(toMap(fns));
        };
      };
      var all1 = all4();
      return {
  ...
  var sizedSize = {
    getWidth: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gesso.Dimensions (line 188, column 14 - line 191, column 74): " + [v.constructor.name]);
    },
    getHeight: function(v) {
      ...
      ;
      throw new Error("Failed pattern match at Gesso.Dimensions (line 192, column 15 - line 195, column 40): " + [v.constructor.name]);
    },
    getRatio: function(v) {
      if (v instanceof WidthAndHeight) {
      ...
      ;
      throw new Error("Failed pattern match at Gesso.Dimensions (line 196, column 14 - line 199, column 50): " + [v.constructor.name]);
    }
  };
  var positionedPoint = {
    getX: function(v) {
  ...
  var toSizeCss = function(dictSized) {
    var getWidth3 = getWidth(dictSized);
    var getHeight3 = getHeight(dictSized);
    return function(sized) {
      return discard2(width3(px(getWidth3(sized))))(function() {
        return height3(px(getHeight3(sized)));
      });
    };
  };
  var toSizeProps = function(dictSized) {
    ...
    var getHeight3 = getHeight(dictSized);
    return function(sized) {
      return [width2(round2(getWidth3(sized))), height2(round2(getHeight3(sized)))];
    };
  };
  var fromXAndY = Point;
  ...
  var largestContainedArea = function(aspectRatio) {
    return function(clientRect) {
      ...
      var go2 = function() {
        ...
        ;
        throw new Error("Failed pattern match at Gesso.Dimensions (line 175, column 3 - line 177, column 29): ");
      }();
      return go2;
    };
  };
  ...
  var eq32 = /* @__PURE__ */ eq(eqPoint);
  var eqDimensions = {
    eq: function(x) {
      return function(y) {
        return eq32(x.value0)(y.value0) && eq22(x.value1)(y.value1);
      };
    }
  };
  ...
  var mkScaler2 = function(viewBox) {
    return function(v) {
          ...
          return function(th2) {
            return function(s) {
              return fromWidthAndHeight({
                width: tw(getWidth3(s)),
                height: th2(getHeight3(s))
              });
            };
          };
        };
      ...
      var transformD = function(dictDimensioned) {
        ...
        var getWidth3 = getWidth(Sized1);
        var getHeight3 = getHeight(Sized1);
        return function(tx) {
          return function(ty) {
            return function(tw) {
              return function(th2) {
                return function(d) {
                  return new Dimensions(fromXAndY({
                    ...
                    width: tw(getWidth3(d)),
                    height: th2(getHeight3(d))
                  }));
                };
              };
            };
      ...
      var toRectangle1 = toRectangle(dimensionedDimensions);
      ...
      return {
        ...
        scaler: {
          canvas: mkScaler(toRectangle1(new Dimensions(origin, v.value1)))({
            x: x$prime,
            y: y$prime,
            width: w$prime,
            height: h$prime
          }),
          drawing: mkScaler(toRectangle1(viewBox))({
            x: toVb["x'"],
            y: toVb["y'"],
            width: toVb["w'"],
            height: toVb["h'"]
  ...
  var Last2 = function(x) {
    return x;
  };
  var Interval = /* @__PURE__ */ function() {
    function Interval2(value0) {
      this.value0 = value0;
    }
    ;
    Interval2.create = function(value0) {
      return new Interval2(value0);
    };
    return Interval2;
  }();
  var Never = /* @__PURE__ */ function() {
    ...
    ;
    Never2.value = new Never2();
    return Never2;
  }();
  var toRatio = function(v) {
    return function(interval) {
      return function(v1) {
        if (interval instanceof Never) {
          return 1;
        }
        ;
        if (interval instanceof Interval) {
          return (v1 - v) / interval.value0;
        }
        ;
        throw new Error("Failed pattern match at Gesso.Time (line 125, column 37 - line 127, column 28): " + [interval.constructor.name]);
      };
    };
  };
  var sort2 = /* @__PURE__ */ sortBy2(/* @__PURE__ */ on(/* @__PURE__ */ compare(ordNumber))(function(v) {
    return v.time;
  }));
  var requestAnimationFrame = function($41) {
    return _requestAnimationFrame(mkEffectFn1($41));
  };
  var never = /* @__PURE__ */ function() {
    return Never.value;
  }();
  ...
  var emptyBatch = /* @__PURE__ */ map11(/* @__PURE__ */ map14(function(v) {
    return {
      last: v,
      items: Nil.value
    };
  })(elapse))(_now);
  var started = /* @__PURE__ */ map11(elapse)(_now);
  ...
  var stampInterval = function(last3) {
    return function(fn) {
      return function(v) {
        ...
        if (v instanceof Interval) {
          var schedule = function($copy_items) {
            return function($copy_v1) {
              return function($copy_v2) {
                ...
                var $tco_done = false;
                var $tco_result;
                function $tco_loop(items2, v1, v2) {
                  if (v1 + v.value0 >= v2) {
                    $tco_done = true;
                    return items2;
                  }
                  ...
                  if (otherwise) {
                    var v3 = v1 + v.value0;
                    var items$prime = new Cons({
                      time: v3,
                      item: fn(delta(v3)(v1))
                    }, items2);
                    $tco_var_items = items$prime;
                    $tco_var_v1 = elapse(v3);
                    $copy_v2 = v2;
                    return;
                  }
                  ;
                  throw new Error("Failed pattern match at Gesso.Time (line 178, column 5 - line 178, column 68): " + [items2.constructor.name, v1.constructor.name, v2.constructor.name]);
                }
                ;
                while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_items, $tco_var_v1, $copy_v2);
                }
                ;
                return $tco_result;
              };
          ...
          var lastTime = function(l) {
            return maybe(last3)(function($42) {
              return Last2(function(v1) {
                return v1.time;
              }($42));
            })(head(l));
          };
          var batch = function(items2) {
            return {
              last: lastTime(items2),
              items: items2
            };
          };
          return map11(map14(batch)(schedule(Nil.value)(last3)))(_now);
        }
        ;
        throw new Error("Failed pattern match at Gesso.Time (line 168, column 25 - line 184, column 66): " + [v.constructor.name]);
      };
    };
  };
  ...
  var position = /* @__PURE__ */ key(valPosition)(/* @__PURE__ */ fromString5("position"));
        ...
        append: function(v) {
          return function(v1) {
            if (v instanceof This && v1 instanceof This) {
              return new This(append16(v.value0)(v1.value0));
            }
            ;
            ...
            if (v instanceof This && v1 instanceof Both) {
              return new Both(append16(v.value0)(v1.value0), v1.value1);
            }
            ;
            ...
            if (v instanceof Both && v1 instanceof This) {
              return new Both(append16(v.value0)(v1.value0), v.value1);
            }
            ;
            ...
            if (v instanceof Both && v1 instanceof Both) {
              return new Both(append16(v.value0)(v1.value0), append25(v.value1)(v1.value1));
            }
            ;
  ...
  var sort3 = /* @__PURE__ */ sort(ordPredicate);
  ...
  var properties = function(xs) {
    ...
    return intercalate4("; ")(map15(sheetRules)(xs));
  };
  ...
  var selector$prime$prime = function(v) {
    return function(v1) {
      ...
      if (v1 instanceof PathChild) {
        return apply3(map15(sepWith(" > "))(selector$prime(v1.value0)))(selector$prime(v1.value1));
      }
      ;
  ...
  var selector$prime = function(v) {
    return map15(function(v1) {
      return v1 + foldMap12(predicate)(sort3(v.value0));
  ...
  var merger = function(v) {
    ...
    if (v.value0 instanceof Pop) {
      return maybe(element3("TODO"))(merger)(nel(drop(v.value0.value0)(cons(v.value0)(v.value1))));
    }
    ;
  ...
  var mediaQuery = function(v) {
    return "@media " + (mediaType(v.value1) + foldl12(append8)(map22(function($212) {
      return function(v1) {
        return " and " + v1;
      }(feature($212));
    })(v.value2)));
  ...
  var rules = function(sel) {
    return function(rs) {
      ...
      var nestedSheets = fold22(map15(uncurry(nestedRules))(mapMaybe(nested)(rs)));
  ...
  var kframe = function(v) {
    ...
    var allKeywordsWithContent = fold12(map15(function(v1) {
  ...
  var value4 = /* @__PURE__ */ value2(valSize);
  var fromString7 = /* @__PURE__ */ fromString(isStringValue);
  var append9 = /* @__PURE__ */ append(semigroupValue);
  var value1 = /* @__PURE__ */ value2(/* @__PURE__ */ valList(valValue));
  ...
  var translate = function(x) {
    return function(y) {
      return append9(fromString7("translate("))(append9(value1([value4(x), value4(y)]))(fromString7(")")));
    };
  };
  ...
  var windowCss = /* @__PURE__ */ function() {
    ...
    var full = discard3(width3(pct(100)))(function() {
      return discard3(height3(pct(100)))(function() {
    ...
    var stretched = discard3(width3(pct(100)))(function() {
      return discard3(height3(pct(100)))(function() {
        return common;
      });
    });
  ...
  var getContextByAppName = function(name15) {
    return bind5(getCanvasElementById(name15))(traverse2(getContext2D));
  };
  var getCanvasClientRect = function(v) {
    return map19(fromDOMRect)(getBoundingClientRect(v));
  };
  var getCanvasByAppName = function(name15) {
    return bind5(bind5(windowImpl)(function() {
      var $22 = map19(toNonElementParentNode);
      return function($23) {
        return $22(document2($23));
      };
    }()))(function() {
      var $24 = map19(map110(Canvas));
  ...
  var toProps = function(toCallback) {
    return function(v) {
      ...
      return append10(map20(toProp)(v.base))(append10(map20(toProp)(v.clipboard))(append10(map20(toProp)(v.focus))(append10(map20(toProp)(v.keyboard))(append10(map20(toProp)(v.touch))(append10(map20(toProp)(v.drag))(append10(map20(toProp)(v.mouse))(map20(toProp)(v.wheel))))))));
    };
  };
  var $$default = {
    base: [],
  ...
  var bind22 = /* @__PURE__ */ bind(/* @__PURE__ */ bindMaybeT(monadHalogenM));
  var lift3 = /* @__PURE__ */ lift(monadTransMaybeT)(monadHalogenM);
  ...
  var Input = /* @__PURE__ */ function() {
    function Input2(value0, value15) {
      this.value0 = value0;
      this.value1 = value15;
    }
    ;
    Input2.create = function(value0) {
      return function(value15) {
        return new Input2(value0, value15);
      };
    };
    return Input2;
  }();
    ...
    var updateDom = function(v) {
      return $$for2(v.dom)(function(d) {
        return function __do2() {
          ...
          var $108 = {};
          for (var $109 in d) {
            if ({}.hasOwnProperty.call(d, $109)) {
              $108[$109] = d[$109];
            }
            ;
          }
          ;
          $108.clientRect = clientRect;
          $108.scaler = mkScaler2(v.viewBox)(clientRect);
          return $108;
        };
      });
    };
    return bind13(bindFlipped4(function() {
      var $198 = liftEffect(monadEffectHalogenM(dictMonadAff.MonadEffect0()));
      return function($199) {
        return $198(updateDom($199));
      };
    }())(get3))(function(dom$prime) {
  ...
  var tryUpdate = function(scaler) {
    return function(update) {
      return function(state3) {
        return function __do2() {
          var v = state3();
          var v1 = update(scaler)(v["new"])();
          if (v1 instanceof Nothing) {
            return state3();
          }
          ;
          ...
          ;
          throw new Error("Failed pattern match at Gesso.Canvas (line 425, column 25 - line 427, column 71): " + [v1.constructor.name]);
        };
      };
    };
  };
  ...
  var saveNewState = function(dictMonadAff) {
    ...
    return function(delta2) {
      return function(scaler) {
        return function(stateVersions) {
          return bind13(get3)(function(v) {
            return discard1(modify_3(function(v1) {
              ...
              ;
              $122.localState = stateVersions["new"];
              return $122;
            }))(function() {
              return bind13(liftEffect7(v.app.output(delta2)(scaler)(stateVersions)))(function(mOutput) {
                return traverse_5(function($200) {
                  return raise(Output($200));
                })(mOutput);
              });
            });
          });
  ...
  var requestAnimationFrame3 = function(callback) {
    return function(notify2) {
      var tick = function() {
        var $201 = Tick.create(notify2);
        return function($202) {
          return notify2($201(elapse($202)));
        };
      }();
      ...
      return function __do2() {
        var $203 = bind6(windowImpl)(requestAnimationFrame(callbackWrapper))();
        return notify2(FrameRequested.create($203))();
      };
    };
  };
  ...
  var queueAnimationFrame = function(lastTime) {
    return function(toIntRatio) {
      return function(context) {
        return function(scaler) {
          return function(stateHistory) {
            return function(app) {
              return function(notify2) {
                var rafCallback = function(timestamp) {
                  var delta2 = delta(timestamp)(lastTime);
                  return function __do2() {
                    var history2 = tryUpdate(scaler)(app.update(delta2))(pure6(stateHistory))();
                    when2(stateHistory.changed)(notify2(new StateUpdated(delta2, scaler, {
                      old: history2.original,
                      "new": history2["new"]
                    })))();
                    return app.render(context)(delta2)(scaler)({
                      old: history2.old,
                      "new": history2["new"],
                      t: toIntRatio(timestamp)
                    })();
                  };
                };
  ...
  var initialize = function(dictMonadAff) {
    ...
    var mkTimers = mapFlipped1(started)(function(t) {
      return new Just({
        frame: t,
        fixed: t
      });
    });
    var mkSubs = bind13(liftEffect7(create))(function(notifications) {
    ...
    var mkDom = function(v) {
      return function __do2() {
        ...
        var canvas2 = getCanvasByAppName(v.name)();
        var clientRect = traverse3(getCanvasClientRect)(canvas2)();
        var scaler = map24(mkScaler2(v.viewBox))(clientRect);
        return apply4(apply4(apply4(map24(function(v1) {
          return function(v2) {
            return function(v3) {
              return function(v4) {
                return {
        ...
        })(clientRect))(canvas2))(context))(scaler);
      };
    };
    return bind13(mkSubs)(function(v) {
      return bind13(liftEffect7(mkTimers))(function(timers) {
        return bind13(get3)(function(state3) {
          return bind13(liftEffect7(mkDom(state3)))(function(dom) {
            return discard1(put3(function() {
              var $136 = {};
              for (var $137 in state3) {
                if ({}.hasOwnProperty.call(state3, $137)) {
                  $136[$137] = state3[$137];
                }
                ;
              }
              ;
              $136.dom = dom;
              $136.subscriptions = v.subscriptions;
              $136.timers = timers;
              return $136;
            }()))(function() {
  ...
  var initialState = function(v) {
    return {
      ...
      timers: Nothing.value,
      pendingUpdates: Nil.value,
      rafId: Nothing.value
    };
  };
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind13(initialize1)(function() {
          var $204 = handleAction2(dictMonadAff);
          return function($205) {
            return $204(FirstTick.create($205));
          };
        }());
      }
      ;
      ...
      if (v instanceof Tick) {
        return bind13(get3)(function(v1) {
          return bind13(runMaybeT(bind22(gets2(function(v2) {
            return v2.timers;
          }))(function(v2) {
            return bind22(gets2(function(v3) {
              return v3.dom;
            }))(function(v3) {
              return lift3(liftEffect7(function __do2() {
                var v4 = stampInterval(v2.fixed)(v1["app"]["fixed"]["function"])(v1.app.fixed.interval)();
                var updateQueue = sort2(append14(v4.items)(v1.pendingUpdates));
                var initialHistory = {
                  original: v1.localState,
                  old: v1.localState,
                  "new": v1.localState,
                  changed: false
                };
                var stateHistory = foldr4(tryUpdate(v3.scaler))(pure6(initialHistory))(mapFlipped22(updateQueue)(function(v5) {
                  return v5.item;
                }))();
                queueAnimationFrame(v.value1)(toRatio(v4.last)(v1.app.fixed.interval))(v3.context)(v3.scaler)(stateHistory)(v1.app)(v.value0)();
                return {
                  "queue'": Nil.value,
                  "timers'": new Just({
                    frame: v.value1,
            ...
            if (results instanceof Nothing) {
              return handleAction2(dictMonadAff)(Finalize2.value);
            }
            ;
            if (results instanceof Just) {
              return modify_3(function(v2) {
                ...
                ;
                $162.pendingUpdates = results["value0"]["queue'"];
                $162.timers = results["value0"]["timers'"];
                return $162;
              });
            }
            ;
            throw new Error("Failed pattern match at Gesso.Canvas (line 286, column 5 - line 289, column 68): " + [results.constructor.name]);
          });
        });
      }
      ;
      ...
      if (v instanceof QueueUpdate) {
        return bind13(get3)(function(v1) {
          return for_2(v1.timers)(function(v2) {
            return bind13(liftEffect7(stamp(v2.frame)(v.value0)))(function(stampedUpdate) {
              return modify_3(function(v3) {
                ...
                ;
                $175.pendingUpdates = new Cons(stampedUpdate, v1.pendingUpdates);
                return $175;
              });
            });
          });
      ...
      if (v instanceof FrameFired) {
        return modify_3(function(v1) {
          ...
          ;
          $189.rafId = Nothing.value;
          return $189;
        });
      }
      ;
      throw new Error("Failed pattern match at Gesso.Canvas (line 238, column 16 - line 305, column 50): " + [v.constructor.name]);
    };
  };
  ...
  var component2 = function(dictMonadAff) {
    return mkComponent({
      ...
      render: memoized(on(eq4)(function() {
        var $206 = map24(function(v) {
          return v.clientRect;
        });
        return function($207) {
          return $206(function(v) {
            return v.dom;
          }($207));
        };
      }()))(render2),
  ...
  // output/Example.Paint.Grid/index.js
  var getX3 = /* @__PURE__ */ getX(positionedPoint);
  var getY3 = /* @__PURE__ */ getY(positionedPoint);
  var sequence_2 = /* @__PURE__ */ sequence_(applicativeEffect);
  var sequence_1 = /* @__PURE__ */ sequence_2(foldableList);
  var map25 = /* @__PURE__ */ map(functorList);
  var sequence_22 = /* @__PURE__ */ sequence_2(foldableArray);
  ...
  var eq23 = /* @__PURE__ */ eq(/* @__PURE__ */ eqMaybe(/* @__PURE__ */ eqRec()(/* @__PURE__ */ eqRowCons(/* @__PURE__ */ eqRowCons(eqRowNil)()({
  ...
  var toXY = function(event) {
    return function(scale3) {
      var point = scale3.point.toVb(positionedPoint)(fromMouseEvent(event));
      var x = floor2(getX3(point));
      var y = floor2(getY3(point));
      return {
        x,
        y
      };
  ...
  var renderApp = function(context) {
    return function(v) {
      return function(scale3) {
        return function(v1) {
          var toRectangle = scale3.toRectangle(dimensionedDimensions);
          var drawPixel = function(v2) {
            return function __do2() {
              setFillStyle(context)(v2.color)();
              return fillRect(context)({
                x: scale3.x.toCr(toNumber(v2.x)),
                y: scale3.y.toCr(toNumber(v2.y)),
                width: scale3.width.toCr(1),
                height: scale3.height.toCr(1)
              })();
            };
          };
          var drawOutline = function __do2() {
            setLineWidth(context)(scale3.width.toCr(0.05))();
            setStrokeStyle(context)("#888")();
            return strokeRect(context)(toRectangle(scale3.screen))();
          };
          var drawImage2 = sequence_1(map25(drawPixel)(reverse2(v1["new"].pixels)));
          var drawGridLine = function(i2) {
            var n = toNumber(i2);
            return strokePath(context)(function __do2() {
              moveTo(context)(scale3.x.toCr(n))(scale3.y.toCr(0))();
              lineTo(context)(scale3.x.toCr(n))(scale3.y.toCr(32))();
              moveTo(context)(scale3.x.toCr(0))(scale3.y.toCr(n))();
              return lineTo(context)(scale3.x.toCr(32))(scale3.y.toCr(n))();
            });
          };
          var drawGrid = function __do2() {
            setStrokeStyle(context)("#ccc")();
            return sequence_22(map111(drawGridLine)(range2(1)(31)))();
          };
          ...
          var clearBackground = function __do2() {
            ...
            return fillRect(context)(toRectangle(scale3.screen))();
          };
          return function __do2() {
            clearBackground();
            drawOutline();
            when3(v1["new"].showGrid)(drawGrid)();
            drawImage2();
            return traverse_6(drawCursor)(v1["new"].mouseCell)();
          };
        };
      };
    };
  };
  var publicInitialState = /* @__PURE__ */ function() {
    return {
      showGrid: true,
      color: "black",
      pixels: Nil.value,
  ...
  var localState = /* @__PURE__ */ function() {
    return merge()()(publicInitialState)({
  ...
  var extractOutput = function(v) {
    return function(v1) {
      return function(v2) {
        return pure7(function() {
          var $105 = v2.old.showGrid !== v2["new"].showGrid || (v2.old.color !== v2["new"].color || (length9(v2.old.pixels) !== length9(v2["new"].pixels) || length9(v2.old.redo) !== length9(v2["new"].redo)));
          if ($105) {
            return new Just({
              showGrid: v2["new"].showGrid,
              color: v2["new"].color,
              pixels: v2["new"].pixels,
              redo: v2["new"].redo
            });
          }
          ;
          ...
          return function(state3) {
            return pure7(function() {
              ...
              if (state3.mouseDown) {
                ...
                ;
                if (v2 instanceof Just) {
                  var $117 = eq33(p2)(v2.value0);
                  if ($117) {
                    var $118 = eq23(state3.mouseCell)(new Just({
                      x: v1.x,
                      y: v1.y
                    }));
                    if ($118) {
                ...
                ;
                throw new Error("Failed pattern match at Example.Paint.Grid (line 132, column 31 - line 141, column 80): " + [v2.constructor.name]);
              }
              ;
              var $120 = eq23(state3.mouseCell)(new Just({
                x: v1.x,
                y: v1.y
              }));
              if ($120) {
  ...
  var canvasInput = /* @__PURE__ */ function() {
    return {
      ...
      localState,
      app: {
        fixed: defaultApp.fixed,
        update: defaultApp.update,
        window: new Fixed(fromWidthAndHeight({
          width: 600,
          height: 600
        })),
        render: renderApp,
  ...
  var component3 = function(dictMonadAff) {
    ...
    return function(action2) {
      return slot2(_gessoCanvas)(unit)(component1)(canvasInput)(action2);
    };
  };
  ...
  var send = function(dictMonadAff) {
    return function(state3) {
      return discard5(tell3(_gessoCanvas)(unit)(Input.create(toIO(state3))))(function() {
        return pure8(unit);
      });
    };
  };
  var render3 = function(dictMonadAff) {
    ...
    return function(state3) {
      ...
      var pixelBlock = function(color) {
        return span2([style3("display: inline-block;" + ("width: 10px;" + ("height: 10px;" + ("border: 1px black solid;" + ("background-color: " + color)))))])([]);
      };
      ...
      var history2 = function(sty) {
        return function(pixels) {
          var listItem = function(v) {
            return li([])([pixelBlock(v.color), span2([style3(sty)])([text(" (" + (show4(v.x) + (", " + (show4(v.y) + ")"))))])]);
          };
          return fromFoldable5(map26(listItem)(pixels));
        };
      };
      var undoRedoHistory = div2([style3(styles.history)])([button([onClick($$const(Undo.value)), style3(styles.control)])([text("\u27F2 Undo")]), button([onClick($$const(Redo.value)), style3(styles.control)])([text("\u27F3 Redo")]), ul([style3("list-style-type: none;")])(append15(history2(styles.redo)(reverse2(state3.redo)))(append15([li([style3(styles.place)])([span2([style3(styles.line)])([])])])(history2("")(state3.pixels))))]);
      var drawing = div2([style3(styles.canvas)])([component1(GotOutput.create), label([style3(styles.label)])([input([type_19(InputCheckbox.value), onClick($$const(ToggleGrid.value)), checked2(state3.showGrid)]), span_([text("Show Grid")])])]);
      var colorPicker = div2([style3(styles.colorPicker)])([slot3(_colorButton)(0)(component)(picker("black"))(ButtonClicked.create), slot3(_colorButton)(1)(component)(picker("#888"))(ButtonClicked.create), slot3(_colorButton)(2)(component)(picker("#ccc"))(ButtonClicked.create), slot3(_colorButton)(3)(component)(picker("white"))(ButtonClicked.create)]);
      return div2([style3(styles.root)])([colorPicker, drawing, undoRedoHistory]);
    };
  };
  var handleAction3 = function(dictMonadAff) {
    var send1 = send(dictMonadAff);
    return function(v) {
      if (v instanceof ToggleGrid) {
        return bind7(modify5(function(s) {
          return {
            color: s.color,
            pixels: s.pixels,
            redo: s.redo,
      ...
      if (v instanceof ButtonClicked) {
        return bind7(modify5(function(v1) {
          return {
            pixels: v1.pixels,
            redo: v1.redo,
      ...
      if (v instanceof Undo) {
        return bind7(get4)(function(state3) {
          var step3 = head(state3.pixels);
          var pixels$prime = fromMaybe(Nil.value)(tail(state3.pixels));
          if (step3 instanceof Nothing) {
            return pure8(unit);
          }
          ;
          if (step3 instanceof Just) {
            var redo$prime = new Cons(step3.value0, state3.redo);
            return bind7(modify5(function(v1) {
              return {
                color: v1.color,
                showGrid: v1.showGrid,
          ...
          ;
          throw new Error("Failed pattern match at Example.Paint.Root (line 136, column 5 - line 141, column 65): " + [step3.constructor.name]);
        });
      }
      ;
      if (v instanceof Redo) {
        return bind7(get4)(function(state3) {
          var step3 = head(state3.redo);
          ...
          ;
          if (step3 instanceof Just) {
            var pixels$prime = new Cons(step3.value0, state3.pixels);
            var state$prime = {
              color: state3.color,
              showGrid: state3.showGrid,
              pixels: pixels$prime,
            ...
            return discard5(put4(state$prime))(function() {
              return send1(state$prime);
            });
          }
          ;
          throw new Error("Failed pattern match at Example.Paint.Root (line 148, column 5 - line 156, column 20): " + [step3.constructor.name]);
        });
      }
      ;
      throw new Error("Failed pattern match at Example.Paint.Root (line 126, column 16 - line 156, column 20): " + [v.constructor.name]);
    };
  };
  var component4 = function(dictMonadAff) {
    return mkComponent({
      initialState: $$const(publicInitialState),
  ...
  var selectElement = function(query3) {
    return bind8(liftEffect3(bindFlipped5(composeKleisliFlipped2(function() {
  ...
  var unsubscribe4 = function(sid) {
    return function(ref2) {
      return function __do2() {
        ...
        return traverse_7(unsubscribe)(bindFlipped6(lookup9(sid))(subs))();
      };
    };
  };
  ...
  var evalQ = function(render4) {
    return function(ref2) {
      return function(q2) {
        return bind14(liftEffect4(read(ref2)))(function(v) {
          return evalM(render4)(ref2)(v["component"]["eval"](new Query(map28(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind14(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind14(liftEffect4(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind14(liftEffect4(read(ref2)))(function(v2) {
                    return discard12(liftEffect4(modify_(map29(insert6(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot4) {
                  return function __do2() {
                    var childrenIn = map30(slot4.pop)(read(childrenInRef))();
                    var $$var2 = function() {
  ...
  var runUI2 = function(component6) {
    return function(i2) {
      return function(element4) {
        return bind16(liftEffect6(map32(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
