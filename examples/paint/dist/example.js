(() => {
            ...
            eqRecord: function(v) {
              return function(ra) {
                return function(rb) {
                  ...
                  return eq(dictEq)(get2(ra))(get2(rb)) && tail3;
                };
              };
            }
          };
      ...
      return function(dictOrd) {
        return function(sym) {
          return function(key2) {
            return function(v) {
              return pop(ordTuple(ordString)(ordOrdBox))(new Tuple(reflectSymbol(dictIsSymbol)(sym), mkOrdBox(dictOrd)(key2)))(v);
            };
          };
        };
      };
    ...
    return function(dictIsSymbol) {
      return function(dictOrd) {
        return function(sym) {
          return function(key2) {
            return function(v) {
              return lookup2(ordTuple(ordString)(ordOrdBox))(new Tuple(reflectSymbol(dictIsSymbol)(sym), mkOrdBox(dictOrd)(key2)))(v);
            };
          };
        };
      };
      ...
      return function(dictOrd) {
        return function(sym) {
          return function(key2) {
            return function(val) {
              return function(v) {
                return insert(ordTuple(ordString)(ordOrdBox))(new Tuple(reflectSymbol(dictIsSymbol)(sym), mkOrdBox(dictOrd)(key2)))(val)(v);
              };
            };
          };
        };
            ...
            return function(q2) {
              return liftF(new ChildQuery2(mkChildQueryBox(new ChildQuery(function(dictApplicative) {
                return function(k) {
                  ...
                  var $141 = lookup3()(dictIsSymbol)(dictOrd)(label5)(p2);
                  return function($142) {
                    return $140($141($142));
                  };
                };
  ...
  var width2 = /* @__PURE__ */ prop2(isPropInt)("width");
  var id2 = /* @__PURE__ */ prop2(isPropString)("id");
  var height2 = /* @__PURE__ */ prop2(isPropInt)("height");
  var checked2 = /* @__PURE__ */ prop2(isPropBoolean)("checked");
  var attr2 = /* @__PURE__ */ function() {
    return attr(Nothing.value);
  }();

  // output/Example.Paint.ColorButton/index.js
  ...
  var ClickedAction = /* @__PURE__ */ function() {
    function ClickedAction2(value0) {
      this.value0 = value0;
    }
    ;
    ClickedAction2.create = function(value0) {
      return new ClickedAction2(value0);
    };
    return ClickedAction2;
  }();
  ...
  var render = function(v) {
    ...
    }), style2("background-color: " + (v.color + ";") + ("width: 72px;" + ("height: 72px;" + ("margin: 6px 12px;" + ("cursor: pointer;" + selectedStyle)))))])([]);
  };
  var handleAction = function(v) {
    if (v instanceof ClickedAction) {
      return raise(new Clicked(v.value0));
    }
    ;
    ...
    ;
    throw new Error("Failed pattern match at Example.Paint.ColorButton (line 62, column 16 - line 64, column 30): " + [v.constructor.name]);
  };
  var component = /* @__PURE__ */ function() {
    return mkComponent({
      ...
      "eval": mkEval({
        ...
        receive: function($11) {
          return Just.create(Update.create($11));
        },
  ...
  var _colorButton = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
      ...
      value: function() {
        ...
        return function($110) {
          return $109(function(v) {
            return map(functorArray)(value2(dictVal))(v);
          }($110));
        };
      }()
    };
  ...
  var element3 = function(e) {
    return new Selector([], new Elem2(e));
  };
  ...
  var key = function(dictVal) {
    return function(k) {
      return function(v) {
        return rule(new Property2(cast(k), value2(dictVal)(v)));
      };
    };
  };
  var functorStyleM = {
  ...
  var px = function(i2) {
    return new BasicSize(append(semigroupValue)(value2(valNumber)(i2))(fromString(isStringValue)("px")));
  };
  var pct = function(i2) {
    return new BasicSize(append(semigroupValue)(value2(valNumber)(i2))(fromString(isStringValue)("%")));
  };

  // output/CSS.Geometry/index.js
  var width3 = /* @__PURE__ */ key(valSize)(/* @__PURE__ */ fromString(isStringKey)("width"));
  ...
  var height3 = /* @__PURE__ */ key(valSize)(/* @__PURE__ */ fromString(isStringKey)("height"));
  ...
  var translate = function(x) {
    return function(y) {
      return append(semigroupValue)(fromString(isStringValue)("translate("))(append(semigroupValue)(value2(valList(valValue))([value2(valSize)(x), value2(valSize)(y)]))(fromString(isStringValue)(")")));
    };
  };
  ...
  var width4 = function(forHeight) {
    return function(v) {
      return forHeight * v.value0 / v.value1;
    };
  };
  var height4 = function(forWidth) {
    return function(v) {
  ...
  var sizedSize = {
    getWidth: function(v) {
      ...
      if (v instanceof HeightAndRatio) {
        return width4(v.value0.height)(v.value0.aspectRatio);
      }
      ;
    ...
    getHeight: function(v) {
      ...
      ;
      if (v instanceof WidthAndRatio) {
        return height4(v.value0.width)(v.value0.aspectRatio);
      }
      ;
      if (v instanceof HeightAndRatio) {
        return v.value0.height;
  ...
  var toSizeCss = function(dictSized) {
    return function(sized) {
      return discard(discardUnit)(bindStyleM)(width3(px(getWidth(dictSized)(sized))))(function() {
        return height3(px(getHeight(dictSized)(sized)));
      });
    };
  };
  var toSizeProps = function(dictSized) {
    return function(sized) {
      return [width2(round2(getWidth(dictSized)(sized))), height2(round2(getHeight(dictSized)(sized)))];
    };
  };
  var fromXAndY = Point;
  ...
  var windowCss = /* @__PURE__ */ function() {
    ...
    var full = discard(discardUnit)(bindStyleM)(width3(pct(100)))(function() {
      return discard(discardUnit)(bindStyleM)(height3(pct(100)))(function() {
    ...
    var stretched = discard(discardUnit)(bindStyleM)(width3(pct(100)))(function() {
      return discard(discardUnit)(bindStyleM)(height3(pct(100)))(function() {
        return common;
      });
    });
  ...
  var merger = function(v) {
    ...
    if (v.value0 instanceof Pop) {
      return maybe(element3("TODO"))(merger)(nel(drop(v.value0.value0)(cons2(v.value0)(v.value1))));
    }
    ;
  ...
  var Input = /* @__PURE__ */ function() {
    ...
    Input2.create = function(value0) {
      return function(value1) {
        return new Input2(value0, value1);
      };
    };
    return Input2;
  }();
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return discard(discardUnit)(bindHalogenM)(initialize(dictMonadAff))(function() {
          return handleAction2(dictMonadAff)(new Tick(Nothing.value));
        });
      }
      ;
  ...
  var handleQuery = function(dictMonadAff) {
    return function(v) {
      return bind(bindHalogenM)(gets(monadStateHalogenM)(function(v1) {
        ...
        return discard(discardUnit)(bindHalogenM)(handleAction2(dictMonadAff)(new QueueUpdate(pureUpdate(v1.input(v.value0)))))(function() {
  ...
  var _gessoCanvas = /* @__PURE__ */ function() {
    return $$Proxy.value;
  }();
  ...
  // output/Example.Paint.Root/index.js
  var ButtonClicked = /* @__PURE__ */ function() {
    function ButtonClicked2(value0) {
      this.value0 = value0;
    }
    ;
    ButtonClicked2.create = function(value0) {
      return new ButtonClicked2(value0);
    };
  ...
  var ToggleGrid = /* @__PURE__ */ function() {
    ...
    ;
    ToggleGrid2.value = new ToggleGrid2();
    return ToggleGrid2;
  }();
  var GotOutput = /* @__PURE__ */ function() {
    function GotOutput2(value0) {
      this.value0 = value0;
    }
    ;
    GotOutput2.create = function(value0) {
      return new GotOutput2(value0);
    };
    return GotOutput2;
  }();
  var toXY = function(event) {
    return function(scale2) {
      var point = scale2.point.toVb(positionedPoint)(fromMouseEvent(event));
      var x = floor2(getX(positionedPoint)(point));
      var y = floor2(getY(positionedPoint)(point));
      return {
        x,
        y
      };
  ...
  var send = function(dictMonadAff) {
    return function(state3) {
      return discard(discardUnit)(bindHalogenM)(tell2()({
        reflectSymbol: function() {
          return "gessoCanvas";
        }
      })(ordUnit)(_gessoCanvas)(unit)(Input.create(toIO(state3))))(function() {
      ...
      return function(scale2) {
        return function(context) {
          var drawPixel = function(v2) {
            return function __do2() {
              setFillStyle(context)(v2.color)();
              return fillRect(context)({
                x: scale2.x.toCr(toNumber(v2.x)),
                y: scale2.y.toCr(toNumber(v2.y)),
                width: scale2.width.toCr(1),
                height: scale2.height.toCr(1)
              })();
            };
          };
          var drawOutline = function __do2() {
            setLineWidth(context)(scale2.width.toCr(0.05))();
            setStrokeStyle(context)("#888")();
            return strokeRect(context)(scale2.toRectangle(dimensionedDimensions)(scale2.screen))();
          };
          var drawImage2 = sequence_(applicativeEffect)(foldableList)(map(functorList)(drawPixel)(reverse2(v.pixels)));
          var drawGridLine = function(i2) {
            var n = toNumber(i2);
            return strokePath(context)(function __do2() {
              moveTo(context)(scale2.x.toCr(n))(scale2.y.toCr(0))();
              lineTo(context)(scale2.x.toCr(n))(scale2.y.toCr(32))();
              moveTo(context)(scale2.x.toCr(0))(scale2.y.toCr(n))();
              return lineTo(context)(scale2.x.toCr(32))(scale2.y.toCr(n))();
            });
          };
          var drawGrid = function __do2() {
            setStrokeStyle(context)("#ccc")();
            return sequence_(applicativeEffect)(foldableArray)(map(functorArray)(drawGridLine)(range(1)(31)))();
          };
          ...
          return function __do2() {
            clearBackground();
            drawOutline();
            when(applicativeEffect)(v.showGrid)(drawGrid)();
            drawImage2();
            return traverse_(applicativeEffect)(foldableMaybe)(drawCursor)(v.mouseCell)();
          };
        };
      };
    };
  ...
  var extractOutput = function(v) {
    return function(v1) {
      return function(state3) {
        return function(v2) {
          var $76 = state3.showGrid !== v2.showGrid || (state3.color !== v2.color || (length(foldableList)(semiringInt)(state3.pixels) !== length(foldableList)(semiringInt)(v2.pixels) || length(foldableList)(semiringInt)(state3.redo) !== length(foldableList)(semiringInt)(v2.redo)));
          if ($76) {
            return new Just({
        ...
        return function(scaler) {
          return function(state3) {
            ...
            if (state3.mouseDown) {
              ...
              ;
              if (v2 instanceof Just) {
                var $86 = eq(eqPixel)(p2)(v2.value0);
                if ($86) {
                  var $87 = eq(eqMaybe(eqRec()(eqRowCons(eqRowCons(eqRowNil)()({
                    reflectSymbol: function() {
                      return "y";
                    }
                  })(eqInt))()({
                  ...
                  })(eqInt))))(state3.mouseCell)(new Just({
                    x: v1.x,
                    y: v1.y
                  }));
                  if ($87) {
            ...
            ;
            var $89 = eq(eqMaybe(eqRec()(eqRowCons(eqRowCons(eqRowNil)()({
              reflectSymbol: function() {
                return "y";
              }
            })(eqInt))()({
  ...
  var handleAction3 = function(dictMonadAff) {
    return function(v) {
      if (v instanceof ToggleGrid) {
        return bind(bindHalogenM)(modify2(monadStateHalogenM)(function(s) {
          return {
            showGrid: !s.showGrid,
            color: s.color,
            pixels: s.pixels,
      ...
      if (v instanceof GotOutput) {
        return bind(bindHalogenM)(get(monadStateHalogenM))(function(current) {
          return modify_2(monadStateHalogenM)(function() {
            var $115 = fromMaybe(current);
            var $116 = convertState(v.value0)(unit)(unit);
            return function($117) {
              return $115($116($117));
            };
          }());
      ...
      if (v instanceof ButtonClicked) {
        return bind(bindHalogenM)(modify2(monadStateHalogenM)(function(v1) {
          return {
      ...
      if (v instanceof Undo) {
        return bind(bindHalogenM)(get(monadStateHalogenM))(function(state3) {
          var step4 = head(state3.pixels);
          var pixels$prime = fromMaybe(Nil.value)(tail(state3.pixels));
          if (step4 instanceof Nothing) {
            return pure(applicativeHalogenM)(unit);
          }
          ;
          if (step4 instanceof Just) {
            var redo$prime = new Cons(step4.value0, state3.redo);
            return bind(bindHalogenM)(modify2(monadStateHalogenM)(function(v1) {
              return {
                pixels: pixels$prime,
                redo: redo$prime,
          ...
          ;
          throw new Error("Failed pattern match at Example.Paint.Root (line 190, column 5 - line 195, column 65): " + [step4.constructor.name]);
        });
      }
      ;
      if (v instanceof Redo) {
        return bind(bindHalogenM)(get(monadStateHalogenM))(function(state3) {
          var step4 = head(state3.redo);
          var redo$prime = fromMaybe(Nil.value)(tail(state3.redo));
          if (step4 instanceof Nothing) {
            return pure(applicativeHalogenM)(unit);
          }
          ;
          if (step4 instanceof Just) {
            var pixels$prime = new Cons(step4.value0, state3.pixels);
            var state$prime = {
              pixels: pixels$prime,
              redo: redo$prime,
              color: state3.color,
            ...
            return discard(discardUnit)(bindHalogenM)(put(monadStateHalogenM)(state$prime))(function() {
              return send(dictMonadAff)(state$prime);
            });
          }
          ;
          throw new Error("Failed pattern match at Example.Paint.Root (line 202, column 5 - line 210, column 20): " + [step4.constructor.name]);
        });
      }
      ;
  ...
  var canvasInput = function(localState) {
    return {
      ...
      localState,
      app: {
        window: fixed(fromWidthAndHeight({
          width: 600,
          height: 600
        })),
        render: renderApp,
      ...
      viewBox: fromPointAndSize(origin)(fromWidthAndRatio({
        width: 32,
        aspectRatio: w1h1
      })),
      interactions: {
  ...
  var canvasInitialState = /* @__PURE__ */ function() {
    return merge()()(initialState2(unit))({
      mouseCell: Nothing.value,
  ...
  var render3 = function(dictMonadAff) {
    return function(state3) {
      ...
      var pixelBlock = function(color) {
        return span2([style2("display: inline-block;" + ("width: 10px;" + ("height: 10px;" + ("border: 1px black solid;" + ("background-color: " + color)))))])([]);
      };
      var picker = function(v) {
        return {
          selected: state3.color,
          color: v
        };
      };
      var history2 = function(sty) {
        return function(pixels) {
          var listItem = function(v) {
            return li([])([pixelBlock(v.color), span2([style2(sty)])([text(" (" + (show(showInt)(v.x) + (", " + (show(showInt)(v.y) + ")"))))])]);
          };
          return fromFoldable(foldableList)(map(functorList)(listItem)(pixels));
        };
      };
      var undoRedoHistory = div2([style2(styles.history)])([button([onClick($$const(Undo.value)), style2(styles.control)])([text("\u27F2 Undo")]), button([onClick($$const(Redo.value)), style2(styles.control)])([text("\u27F3 Redo")]), ul([style2("list-style-type: none;")])(append(semigroupArray)(history2(styles.redo)(reverse2(state3.redo)))(append(semigroupArray)([li([style2(styles.place)])([span2([style2(styles.line)])([])])])(history2("")(state3.pixels))))]);
      var drawing = div2([style2(styles.canvas)])([slot()({
        reflectSymbol: function() {
          return "gessoCanvas";
        }
      })(ordUnit)(_gessoCanvas)(unit)(component2(dictMonadAff))(canvasInput(canvasInitialState))(GotOutput.create), label([style2(styles.label)])([input([type_3(isPropInputType)(InputCheckbox.value), onClick($$const(ToggleGrid.value)), checked2(state3.showGrid)]), span_([text("Show Grid")])])]);
      var colorPicker = div2([style2(styles.colorPicker)])([slot()({
        reflectSymbol: function() {
          return "colorButton";
        }
      })(ordInt)(_colorButton)(0)(component)(picker("black"))(ButtonClicked.create), slot()({
        reflectSymbol: function() {
          return "colorButton";
        }
      })(ordInt)(_colorButton)(1)(component)(picker("#888"))(ButtonClicked.create), slot()({
        reflectSymbol: function() {
          return "colorButton";
        }
      })(ordInt)(_colorButton)(2)(component)(picker("#ccc"))(ButtonClicked.create), slot()({
        reflectSymbol: function() {
          return "colorButton";
        }
      })(ordInt)(_colorButton)(3)(component)(picker("white"))(ButtonClicked.create)]);
      return div2([style2(styles.root)])([colorPicker, drawing, undoRedoHistory]);
    };
  };
  ...
  var evalQ = function(render4) {
    return function(ref2) {
      return function(q2) {
        return bind(bindAff)(liftEffect(monadEffectAff)(read(ref2)))(function(v) {
          return evalM(render4)(ref2)(v["component"]["eval"](new Query(map(functorCoyoneda)(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
              ...
              return bind(bindAff)(liftEffect(monadEffectAff)(read(ref2)))(function(v2) {
                ...
                if (otherwise) {
                  return discard(discardUnit)(bindAff)(liftEffect(monadEffectAff)(write({
                    ...
                    return discard(discardUnit)(bindAff)(handleLifecycle(v2.lifecycleHandlers)(render4(v2.lifecycleHandlers)(ref2)))(function() {
                      return pure(applicativeAff)(v3.value0);
                    });
                  });
                }
                      ...
                      if (childrenIn instanceof Just) {
                        ...
                        unDriverStateX(function(st) {
                          return function __do3() {
                            ...
                            return handleAff(evalM(render4)(st.selfRef)(st["component"]["eval"](new Receive(slot2.input, unit))))();
                          };
                        })(dsx)();
    ...
    return function(i2) {
      return function(element4) {
        return bind(bindAff)(liftEffect(monadEffectAff)(map(functorEffect)(toDocument)(bindFlipped(bindEffect)(document2)(windowImpl))))(function(document3) {
          return runUI(renderSpec(document3)(element4))(component4)(i2);
        });
      };
    };
  };

  // output/Example.Paint.Main/index.js
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return runUI2(component3(monadAffAff))(unit)(body2);
  }));
