...
(function($PS) {
  ...
  exports["positionedDimensions"] = positionedDimensions;
...
(function($PS) {
  ...
  var canvas = function (dictMonadAff) {
      return Gesso_Canvas.component(dictMonadAff);
  };
...
(function($PS) {
  "use strict";
  $PS["Example.ControllingBall.Main"] = $PS["Example.ControllingBall.Main"] || {};
  var exports = $PS["Example.ControllingBall.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect_Aff = $PS["Effect.Aff"];
          ...
          return function (min) {
              return function (max) {
                  return function (v) {
                      ...
                      throw new Error("Failed pattern match at Example.ControllingBall.Main (line 104, column 1 - line 104, column 68): " + [ p.constructor.name, r.constructor.name, min.constructor.name, max.constructor.name, v.constructor.name ]);
                  };
              };
          };
      };
  ...
  var render = function (v) {
      return function (v1) {
          return function (scale) {
              return function (context) {
                  return function __do() {
                      Graphics_Canvas.clearRect(context)(scale.toRectangle(Gesso_Dimensions.dimensionedDimensions)(scale.screen))();
                      Graphics_Canvas.setFillStyle(context)("red")();
  ...
  var mouseDown = (function () {
      var go = function (event) {
          return function (v) {
              return function (v1) {
                  return function (state) {
                      var point = Gesso_Dimensions.fromMouseEvent(event);
                      return new Data_Maybe.Just({
                          x: Gesso_Dimensions.getX(Gesso_Dimensions.positionedPoint)(point),
                          y: Gesso_Dimensions.getY(Gesso_Dimensions.positionedPoint)(point),
                          keys: state.keys,
                          radius: state.radius
                      });
                  };
      ...
      return Gesso_Interactions.mkInteraction(Halogen_HTML_Events.onMouseDown)(go);
  })();
  var keyUp = (function () {
      var go = function (event) {
          return function (v) {
              return function (v1) {
                  return function (state) {
                      var v2 = Web_UIEvent_KeyboardEvent.key(event);
                      if (v2 === "ArrowUp") {
                          return new Data_Maybe.Just({
                              keys: {
                                  up: false,
      ...
      return Gesso_Interactions.mkInteraction(Halogen_HTML_Events.onKeyUp)(go);
  })();
  var keyDown = (function () {
      ...
      return Gesso_Interactions.mkInteraction(Halogen_HTML_Events.onKeyDown)(go);
  })();
  ...
  var update = function (v) {
      return function (scale) {
          return function (v1) {
              var yMin = Gesso_Dimensions.getY(Gesso_Dimensions.positionedDimensions)(scale.screen);
              var yMax = yMin + Gesso_Dimensions.getHeight(Gesso_Dimensions.sizedDimensions)(scale.screen);
              var xMin = Gesso_Dimensions.getX(Gesso_Dimensions.positionedDimensions)(scale.screen);
              var xMax = xMin + Gesso_Dimensions.getWidth(Gesso_Dimensions.sizedDimensions)(scale.screen);
  ...
  var canvasInput = {
      ...
      app: {
          ...
          render: render,
          update: Gesso_Application.pureUpdate(update),
  ...
  var main = Gesso.runGessoAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Gesso.run(Gesso.canvas(Effect_Aff_Class.monadAffAff))(canvasInput)(body);
  }));
  exports["main"] = main;
...
PS["Example.ControllingBall.Main"].main();