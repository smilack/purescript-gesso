(() => {
                    ...
                    return function(scaler) {
                      return function(update2) {
                        return function(s) {
                          return function __do2() {
                            var v = s();
                            var mstate$prime = runUpdate(delta2)(scaler)(v.value1)(update2)();
  ...
  var run3 = function(component2) {
    return function(input3) {
      return function(element4) {
        return bind(bindAff)(runUI2(component2)(input3)(element4))(function() {
      ...
      return function(min5) {
        return function(max6) {
          return function(v) {
            ...
            ;
            throw new Error("Failed pattern match at Example.ControllingBall.Main (line 102, column 1 - line 102, column 68): " + [p2.constructor.name, r.constructor.name, min5.constructor.name, max6.constructor.name, v.constructor.name]);
          };
        };
      };
    };
  ...
  var mouseDown = /* @__PURE__ */ function() {
      ...
      return function(v) {
        return function(v1) {
          return function(state3) {
            ...
            return new Just({
              x: getX(positionedPoint)(point),
              y: getY(positionedPoint)(point),
              keys: state3.keys,
    ...
    return mkInteraction(onMouseDown)(go2);
  }();
  var keyUp = /* @__PURE__ */ function() {
    ...
    return mkInteraction(onKeyUp)(go2);
  }();
  var keyDown = /* @__PURE__ */ function() {
    ...
    return mkInteraction(onKeyDown)(go2);
  }();
  var getV = function(neg) {
    return function(pos) {
      if (!neg) {
        ...
        ;
        throw new Error("Failed pattern match at Example.ControllingBall.Main (line 95, column 12 - line 97, column 16): " + [pos.constructor.name]);
      }
      ;
      if (neg) {
        if (!pos) {
        ...
        ;
        throw new Error("Failed pattern match at Example.ControllingBall.Main (line 98, column 11 - line 100, column 16): " + [pos.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Example.ControllingBall.Main (line 94, column 16 - line 100, column 16): " + [neg.constructor.name]);
    };
  };
  var update = function(v) {
    return function(scale2) {
      return function(v1) {
        var yMin = getY(positionedDimensions)(scale2.screen);
        var yMax = yMin + getHeight(sizedDimensions)(scale2.screen);
        var xMin = getX(positionedDimensions)(scale2.screen);
        var xMax = xMin + getWidth(sizedDimensions)(scale2.screen);
  ...
  var main2 = /* @__PURE__ */ runGessoAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return run3(canvas2(monadAffAff))(canvasInput)(body2);
  }));
