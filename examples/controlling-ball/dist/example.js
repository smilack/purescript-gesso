...
(() => {
  ...
  var properties = function(xs) {
    ...
    return intercalate4("; ")(map7(sheetRules)(xs));
  };
  ...
  var selector$prime$prime = function(v) {
    return function(v1) {
      ...
      if (v1 instanceof PathChild) {
        return apply3(map7(sepWith(" > "))(selector$prime(v1.value0)))(selector$prime(v1.value1));
      }
      ;
  ...
  var rules = function(sel) {
    return function(rs) {
      ...
      var nestedSheets = fold22(map7(uncurry(nestedRules))(mapMaybe(nested)(rs)));
  ...
  var kframe = function(v) {
    ...
    var allKeywordsWithContent = fold12(map7(function(v1) {
  ...
  var emptyBatch = /* @__PURE__ */ map10(/* @__PURE__ */ map15(function(v) {
    return {
      last: v,
      items: Nil.value
    };
  })(elapse))(_now);
  var started = /* @__PURE__ */ map10(elapse)(_now);
    ...
    return function(fn) {
      return function(v) {
        ...
        if (v instanceof Interval) {
          ...
          return map10(map15(batch)(schedule(Nil.value)(last3)))(_now);
        }
        ;
  ...
  var getCanvasClientRect = function(v) {
    return map17(fromDOMRect)(getBoundingClientRect(v));
  };
  var getCanvasByAppName = function(name15) {
    return bind4(bind4(windowImpl)(function() {
      var $22 = map17(toNonElementParentNode);
      return function($23) {
        return $22(document2($23));
      };
    }()))(function() {
      var $24 = map17(map18(Canvas));
  ...
  var toProps = function(toCallback) {
    return function(v) {
      ...
      return append7(map19(toProp)(v.base))(append7(map19(toProp)(v.clipboard))(append7(map19(toProp)(v.focus))(append7(map19(toProp)(v.keyboard))(append7(map19(toProp)(v.touch))(append7(map19(toProp)(v.drag))(append7(map19(toProp)(v.mouse))(map19(toProp)(v.wheel))))))));
    };
  };
  var $$default = {
    base: [],
  ...
  var lookup7 = /* @__PURE__ */ lookup4(ordSubscriptionId);
  ...
  var lookup1 = /* @__PURE__ */ lookup4(ordForkId);
  ...
  var evalQ = function(render3) {
    return function(ref2) {
      return function(q2) {
        return bind14(liftEffect3(read(ref2)))(function(v) {
          return evalM(render3)(ref2)(v["component"]["eval"](new Query2(map25(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
            ...
            if (v1 instanceof Subscribe) {
              return bind14(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind14(liftEffect3(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind14(liftEffect3(read(ref2)))(function(v2) {
                    return discard12(liftEffect3(modify_(map26(insert5(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            return function(childrenInRef) {
              return function(childrenOutRef) {
                return unComponentSlot(function(slot) {
                  return function __do2() {
                    var childrenIn = map27(slot.pop)(read(childrenInRef))();
                    var $$var2 = function() {
  ...
  var runUI2 = function(component2) {
    return function(i2) {
      return function(element4) {
        return bind16(liftEffect6(map30(toDocument)(bindFlipped8(document2)(windowImpl))))(function(document3) {
      ...
      return function(min5) {
        return function(max6) {
          return function(v) {
            ...
            ;
            throw new Error("Failed pattern match at Example.ControllingBall.Main (line 104, column 1 - line 104, column 68): " + [p2.constructor.name, r.constructor.name, min5.constructor.name, max6.constructor.name, v.constructor.name]);
          };
        };
      };
    };
  ...
  var render2 = function(context) {
    return function(v) {
      return function(scale3) {
        return function(v1) {
          return function __do2() {
            clearRect(context)(scale3.toRectangle(dimensionedDimensions)(scale3.screen))();
            setFillStyle(context)("red")();
            return fillPath(context)(arc(context)({
              x: v1["new"].x,
              y: v1["new"].y,
              radius: v1["new"].radius,
              start: 0,
              end: 2 * pi,
  ...
  var getV = function(neg) {
    return function(pos) {
      if (!neg) {
        ...
        ;
        throw new Error("Failed pattern match at Example.ControllingBall.Main (line 97, column 12 - line 99, column 16): " + [pos.constructor.name]);
      }
      ;
      if (neg) {
        if (!pos) {
        ...
        ;
        throw new Error("Failed pattern match at Example.ControllingBall.Main (line 100, column 11 - line 102, column 16): " + [pos.constructor.name]);
      }
      ;
      throw new Error("Failed pattern match at Example.ControllingBall.Main (line 96, column 16 - line 102, column 16): " + [neg.constructor.name]);
    };
  };
  var update = function(v) {
    return function(scale3) {
      return function(v1) {
        var yMin = getY12(scale3.screen);
        var yMax = yMin + getHeight3(scale3.screen);
        var xMin = getX12(scale3.screen);
        var xMax = xMin + getWidth3(scale3.screen);
