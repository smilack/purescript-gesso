...
(() => {
  ...
  var toSizeProps = function(dictSized) {
    ...
    var getHeight3 = getHeight(dictSized);
    return function(sized) {
      return [width3(round2(getWidth32(sized))), height3(round2(getHeight3(sized)))];
    };
  };
  var fromXAndY = Point;
  ...
  var hz = function(fps) {
    ...
    ;
    if (otherwise) {
      return new Interval(1e3 / fps);
    }
    ;
    throw new Error("Failed pattern match at Gesso.Time (line 131, column 1 - line 131, column 25): " + [fps.constructor.name]);
  };
  ...
  // output/Gesso.Util.Lerp/index.js
  var lerp = function(dictRing) {
    ...
    return function(v) {
      return add2(mul2(sub3(one2)(v.t))(v.old))(mul2(v.t)(v["new"]));
    };
  };

  // output/Example.Interpolation.Main/index.js
  var lerp2 = /* @__PURE__ */ lerp(ringNumber);
  var getX3 = /* @__PURE__ */ getX(positionedDimensions);
  ...
  var render2 = function(context) {
    return function(v) {
      return function(v1) {
        return function(v2) {
          var v3 = function() {
            var v4 = parity(trunc2(v2["new"].seconds));
            if (v4 instanceof Even) {
              return {
                x: lerp2({
                  t: v2.t,
                  old: v2.old.ball.x,
            ...
            ;
            throw new Error("Failed pattern match at Example.Interpolation.Main (line 87, column 21 - line 97, column 8): " + [v4.constructor.name]);
          }();
          return function __do2() {
            setLineWidth(context)(10)();
            setStrokeStyle(context)(v3.color)();
            return strokePath(context)(arc(context)({
              x: v3.x,
              y: v3.y,
              radius: v2["new"].ball.r,
              start: 0,
              end: 2 * pi,
  ...
  var move = function(v) {
    return function(dt2) {
      return function(v1) {
        var x$prime = v1.x + v1.vx * dt2;
        var vx$prime = function() {
          if (x$prime + v1.r + v1.vx > v.max) {
            return 0 - abs(v1.vx);
          }
          ;
          if (x$prime - v1.r + v1.vx < v.min) {
            return abs(v1.vx);
          }
          ;
          if (otherwise) {
          ...
          ;
          throw new Error("Failed pattern match at Example.Interpolation.Main (line 63, column 3 - line 66, column 21): ");
        }();
        return {
          y: v1.y,
          r: v1.r,
  ...
  var fixedUpdate = function(v) {
    return function(scale3) {
      return function(v1) {
        var min5 = getX3(scale3.screen);
        var max6 = min5 + getWidth3(scale3.screen);
        return pure14(new Just({
          ball: move({
            min: min5,
            max: max6
          })(v.delta)(v1.ball),
          seconds: v1.seconds + v.delta / 1e3
        }));
      };
    };
  };
