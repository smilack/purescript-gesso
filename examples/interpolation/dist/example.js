...
(() => {
  ...
  var hz = function(fps) {
    ...
    ;
    if (otherwise) {
      return new Interval(1 / fps);
    }
    ;
    throw new Error("Failed pattern match at Gesso.Time (line 119, column 1 - line 119, column 25): " + [fps.constructor.name]);
  };
      ...
      return function(scale2) {
        return function(v1) {
          return function __do2() {
            ...
            setFont(context)("32pt Arial")();
            fillText(context)(show4(1e3 / v.delta))(30)(60)();
            setFillStyle(context)("red")();
            fillPath(context)(arc(context)({
              x: v1.current.smooth.x,
              y: v1.current.smooth.y,
              radius,
              start: 0,
              end: 2 * pi,
              useCounterClockwise: false
            }))();
            setFillStyle(context)("blue")();
            return fillPath(context)(arc(context)({
              x: v1.current.jitter.x,
              y: v1.current.jitter.y,
              radius,
              start: 0,
              end: 2 * pi,
              useCounterClockwise: false
  ...
  var updateDirection = function(v) {
    if (v.d + radius + v.v > v.max) {
      return -velocity;
    }
    ;
    if (v.d - radius + v.v < v.min) {
      return velocity;
    }
    ;
    if (otherwise) {
    ...
    ;
    throw new Error("Failed pattern match at Example.Interpolation.Main (line 100, column 1 - line 101, column 74): " + [v.constructor.name]);
  };
  ...
  var move = function(v) {
    return function(delta2) {
      return function(obj) {
        var vy = updateDirection({
          d: obj.y,
          min: v.min.y,
          max: v.max.y,
          v: obj.vy
        });
        var vx = updateDirection({
          d: obj.x,
          min: v.min.x,
          max: v.max.x,
          v: obj.vx
  ...
  var initialState2 = {
    smooth: /* @__PURE__ */ object2({
      x: 25,
      y: 12.5
    }),
    jitter: /* @__PURE__ */ object2({
      x: 75,
      y: 12.5
    })
  };
  var fixedUpdate = function(v) {
    return function(scale2) {
      return function(v1) {
        var min5 = {
          x: getX3(scale2.screen),
          y: getY3(scale2.screen)
        };
        var max6 = {
          x: min5.x + getWidth3(scale2.screen),
          y: min5.y + getHeight3(scale2.screen)
        };
        var borders = {
          min: min5,
          max: max6
        ...
        return pure14(new Just({
          smooth: move(borders)(v.delta)(v1.smooth),
          jitter: move(borders)(v.delta)(v1.jitter)
        }));
      };
    };
  };
