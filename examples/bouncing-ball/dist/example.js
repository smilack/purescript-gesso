...
(() => {
  ...
  var getY3 = /* @__PURE__ */ getY(positionedDimensions);
      ...
      return function(min5) {
        return function(max6) {
          return function(velocity) {
            ...
            ;
            throw new Error("Failed pattern match at Example.BouncingBall.Main (line 56, column 1 - line 56, column 68): " + [position3.constructor.name, radius.constructor.name, min5.constructor.name, max6.constructor.name, velocity.constructor.name]);
          };
        };
      };
    };
  ...
  var update = function(v) {
    return function(scale3) {
      return function(v1) {
        var yMin = getY3(scale3.screen);
        var yMax = yMin + getHeight3(scale3.screen);
        var xMin = getX3(scale3.screen);
