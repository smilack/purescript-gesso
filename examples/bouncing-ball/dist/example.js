(() => {
  ...
  // output/Example.BouncingBall.Main/index.js
  var updateV = function(position3) {
    return function(radius) {
      return function(min5) {
        return function(max6) {
          return function(velocity) {
            if (position3 + radius + velocity > max6) {
              return -1;
            }
            ;
            if (position3 - radius + velocity < min5) {
              return 1;
            }
            ;
            if (otherwise) {
            ...
            ;
            throw new Error("Failed pattern match at Example.BouncingBall.Main (line 54, column 1 - line 54, column 68): " + [position3.constructor.name, radius.constructor.name, min5.constructor.name, max6.constructor.name, velocity.constructor.name]);
          };
        };
      };
    };
  ...
  var update = function(v) {
    return function(scale2) {
      return function(v1) {
        ...
        var vy$prime = updateV(v1.y)(v1.radius)(yMin)(yMax)(v1.vy);
        var vx$prime = updateV(v1.x)(v1.radius)(xMin)(xMax)(v1.vx);
        return new Just({
          x: v1.x + vx$prime,
          vx: vx$prime,
          y: v1.y + vy$prime,
