...
(function($PS) {
  "use strict";
  $PS["Example.BouncingBall.Main"] = $PS["Example.BouncingBall.Main"] || {};
  var exports = $PS["Example.BouncingBall.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect_Aff = $PS["Effect.Aff"];
          ...
          return function (min) {
              return function (max) {
                  return function (vt) {
                      ...
                      throw new Error("Failed pattern match at Example.BouncingBall.Main (line 53, column 1 - line 53, column 68): " + [ t.constructor.name, r.constructor.name, min.constructor.name, max.constructor.name, vt.constructor.name ]);
                  };
              };
          };
      };
...
PS["Example.BouncingBall.Main"].main();