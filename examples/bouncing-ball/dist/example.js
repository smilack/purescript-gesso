      ...
      return function(min5) {
        return function(max6) {
          return function(velocity) {
            ...
            ;
            throw new Error("Failed pattern match at Example.BouncingBall.Main (line 55, column 1 - line 55, column 68): " + [position3.constructor.name, radius.constructor.name, min5.constructor.name, max6.constructor.name, velocity.constructor.name]);
          };
        };
      };
    };
