...
(() => {
  ...
  var sortByImpl = /* @__PURE__ */ function() {
    function mergeFromTo(compare4, fromOrdering, xs1, xs2, from2, to3) {
      var mid;
      var i2;
      var j;
      var k;
  ...
  var unsafeDelete = function(label5) {
    return function(rec) {
      var copy2 = {};
      for (var key3 in rec) {
        if (key3 !== label5 && {}.hasOwnProperty.call(rec, key3)) {
          copy2[key3] = rec[key3];
        }
      }
      return copy2;
  ...
  var Time = /* @__PURE__ */ function() {
    function Time2(value0, value15, value22, value32) {
      this.value0 = value0;
      this.value1 = value15;
      this.value2 = value22;
      this.value3 = value32;
      ...
      return function(value15) {
        return function(value22) {
          return function(value32) {
            return new Time2(value0, value15, value22, value32);
          };
        };
      };
    };
  ...
  var $$Date = /* @__PURE__ */ function() {
    function $$Date2(value0, value15, value22) {
      this.value0 = value0;
      this.value1 = value15;
      this.value2 = value22;
    }
    ...
    $$Date2.create = function(value0) {
      return function(value15) {
        return function(value22) {
          return new $$Date2(value0, value15, value22);
        };
      };
    };
    return $$Date2;
  ...
  var DateTime = /* @__PURE__ */ function() {
    function DateTime2(value0, value15) {
      this.value0 = value0;
      this.value1 = value15;
    }
    ;
    DateTime2.create = function(value0) {
      return function(value15) {
        return new DateTime2(value0, value15);
      };
    };
    return DateTime2;
  }();
  ...
  var nowTime = /* @__PURE__ */ map6(function($2) {
    ...
    append: function(v) {
      return function(v1) {
        ...
        if (v instanceof Plain && v1 instanceof Prefixed) {
          return new Prefixed(map7(second3(function(v2) {
            return v.value0 + v2;
          }))(v1.value0));
        }
        ;
  ...
  var properties = function(xs) {
    ...
    return intercalate4("; ")(map8(sheetRules)(xs));
  };
  ...
  var selector$prime$prime = function(v) {
    return function(v1) {
      ...
      if (v1 instanceof PathChild) {
        return apply3(map8(sepWith(" > "))(selector$prime(v1.value0)))(selector$prime(v1.value1));
      }
      ;
  ...
  var rules = function(sel) {
    return function(rs) {
      ...
      var nestedSheets = fold22(map8(uncurry(nestedRules))(mapMaybe(nested)(rs)));
  ...
  var kframe = function(v) {
    ...
    var allKeywordsWithContent = fold12(map8(function(v1) {
  ...
  var nub3 = /* @__PURE__ */ nub2();
  var lookup1 = /* @__PURE__ */ lookup4(ordString);
  var insert1 = /* @__PURE__ */ insert3()();
  var identity6 = /* @__PURE__ */ identity(categoryFn);
  var compose1 = /* @__PURE__ */ compose(semigroupoidBuilder);
  var widthTo = function(n) {
    return function(v) {
      return v.scaling.width(n);
    };
  };
  var toMap = function(v) {
    return fromFoldable3([new Tuple("x", v.x), new Tuple("x1", v.x), new Tuple("x2", v.x), new Tuple("y", v.y), new Tuple("y1", v.y), new Tuple("y2", v.y), new Tuple("width", v.width), new Tuple("w", v.width), new Tuple("height", v.height), new Tuple("h", v.height), new Tuple("radius", v.width), new Tuple("r", v.width)]);
  };
  var to = function() {
    return function(dictScalable) {
      return function(r) {
        return function(v) {
          return buildFromScratch(v.scaling.all()(dictScalable)(r));
        };
      };
    };
  };
  ...
  var lookup5 = function(dictIsSymbol) {
    return lookup1(reflectSymbol(dictIsSymbol)($$Proxy.value));
  };
  var insert4 = function(dictIsSymbol) {
    var insert22 = insert1(dictIsSymbol);
    return function() {
      return function() {
        return insert22($$Proxy.value);
      };
    };
  };
  var heightTo = function(n) {
    return function(v) {
      return v.scaling.height(n);
    };
  };
  var get3 = function(dictIsSymbol) {
    ...
    return function() {
      return function() {
        return get1($$Proxy.value);
      };
    };
  };
  var scaleRecScalableType = function(dictIsSymbol) {
    var insert22 = insert4(dictIsSymbol)()();
    var lookup23 = lookup5(dictIsSymbol);
    var get1 = get3(dictIsSymbol)()();
    return function() {
      return function() {
        return function(m) {
          var $103 = fromMaybe(identity6)(lookup23(m));
          return function($104) {
            return insert22($103(get1($104)));
          };
        };
      };
    };
  ...
  var $$delete4 = function(dictIsSymbol) {
    var delete1 = $$delete3(dictIsSymbol)()();
    return function() {
      return function() {
        return delete1($$Proxy.value);
      };
    };
  };
  var scaleRecRecur = function() {
    return function(dictScalable) {
      var scale1 = scale(dictScalable);
      return function(dictIsSymbol) {
        var delete1 = $$delete4(dictIsSymbol)()();
        return function() {
          return function() {
            return function(m) {
              var $105 = scale1(m);
              return function($106) {
                return $105(delete1($106));
              };
            };
          };
        };
  ...
  var scaleRecRecur1 = /* @__PURE__ */ scaleRecRecur();
  var scalableRecScalableType = function() {
    return function(dictIsSymbol) {
      var scaleRecScalableType1 = scaleRecScalableType(dictIsSymbol)()();
      return function() {
        return function() {
          return function(dictScalable) {
            var scaleRecRecur2 = scaleRecRecur1(dictScalable)(dictIsSymbol)()();
            return {
              scale: function(m) {
                return function(r) {
                  return compose1(scaleRecScalableType1(m)(r))(scaleRecRecur2(m)(r));
                };
              },
              RowToList0: function() {
                return void 0;
  ...
  var runGraft = /* @__PURE__ */ unGraft(function(v) {
    var go2 = function(v2) {
      ...
      if (v2 instanceof Elem2) {
        return new Elem2(v2.value0, v2.value1, v.value0(v2.value2), map9(go2)(v2.value3));
      }
      ;
      if (v2 instanceof Keyed) {
        return new Keyed(v2.value0, v2.value1, v.value0(v2.value2), map9(map14(go2))(v2.value3));
      }
      ;
    ...
    var sequences = function(v) {
      if (v instanceof Cons && v.value1 instanceof Cons) {
        if (eq3(cmp(v.value0)(v.value1.value0))(GT.value)) {
          return descending(v.value1.value0)(singleton6(v.value0))(v.value1.value1);
        }
        ;
        if (otherwise) {
      ...
      return function($copy_v1) {
        return function($copy_v2) {
          ...
          function $tco_loop(v, v1, v2) {
            ...
            ;
            $tco_done2 = true;
            return new Cons(v1(singleton6(v)), sequences(v2));
          }
          ;
          while (!$tco_done2) {
            $tco_result = $tco_loop($tco_var_v, $tco_var_v1, $copy_v2);
  ...
  var toSizeCss = function(dictSized) {
    ...
    return function(sized) {
      return discard2(width(px(getWidth3(sized))))(function() {
        return height(px(getHeight3(sized)));
      });
    };
  };
  var toSizeProps = function(dictSized) {
    ...
    var getHeight3 = getHeight(dictSized);
    return function(sized) {
      return [width3(round2(getWidth3(sized))), height3(round2(getHeight3(sized)))];
    };
  };
  var fromXAndY = Point;
  ...
  var mkScaler2 = function(viewBox) {
    return function(v) {
      ...
      var transformP = function(dictPositioned) {
        var getX3 = getX(dictPositioned);
        var getY3 = getY(dictPositioned);
        return function(tx) {
          return function(ty) {
            return function(p2) {
              return fromXAndY({
      ...
      var transformD = function(dictDimensioned) {
        ...
        var getX3 = getX(Positioned0);
        var getY3 = getY(Positioned0);
  ...
  var sort3 = /* @__PURE__ */ sortBy2(/* @__PURE__ */ on(/* @__PURE__ */ compare(ordNumber))(function(v) {
    return v.time;
  }));
  ...
  var emptyBatch = /* @__PURE__ */ map11(/* @__PURE__ */ map15(function(v) {
    return {
      last: v,
      items: Nil.value
    };
    ...
    return function(fn) {
      return function(v) {
        ...
        if (v instanceof Interval) {
          ...
          return map11(map15(batch)(schedule(Nil.value)(last3)))(_now);
        }
        ;
  ...
  var getCanvasClientRect = function(v) {
    return map18(fromDOMRect)(getBoundingClientRect(v));
  };
  var getCanvasByAppName = function(name15) {
    return bind4(bind4(windowImpl)(function() {
      var $22 = map18(toNonElementParentNode);
      return function($23) {
        return $22(document2($23));
      };
    }()))(function() {
      var $24 = map18(map19(Canvas));
  ...
  var toProps = function(toCallback) {
    return function(v) {
      ...
      return append7(map20(toProp)(v.base))(append7(map20(toProp)(v.clipboard))(append7(map20(toProp)(v.focus))(append7(map20(toProp)(v.keyboard))(append7(map20(toProp)(v.touch))(append7(map20(toProp)(v.drag))(append7(map20(toProp)(v.mouse))(map20(toProp)(v.wheel))))))));
    };
  };
  var $$default = {
    base: [],
  ...
  var initialize = function(dictMonadAff) {
    ...
    var mkDom = function(v) {
      return function __do2() {
        ...
        var scaler = map25(mkScaler2(v.viewBox))(clientRect);
        return apply4(apply4(apply4(map25(function(v1) {
          return function(v2) {
            return function(v3) {
              return function(v4) {
                return {
    ...
    return function(v) {
      if (v instanceof Initialize2) {
        return bind13(initialize1)(function() {
          var $204 = handleAction(dictMonadAff);
          return function($205) {
      ...
      if (v instanceof Tick) {
        return bind13(get4)(function(v1) {
          return bind13(runMaybeT(bind22(gets2(function(v2) {
            ...
            return bind22(gets2(function(v3) {
              ...
              return lift3(liftEffect7(function __do2() {
                ...
                var updateQueue = sort3(append14(v4.items)(v1.pendingUpdates));
                var initialHistory = {
        ...
        return function(lchs) {
          return function __do2() {
            ...
            var ds = {
              ...
              state: component3.initialState(input4),
              refs: empty2,
              children: empty4,
              childrenIn,
              childrenOut,
  ...
  var evalQ = function(render3) {
    return function(ref2) {
      return function(q2) {
        return bind14(liftEffect3(read(ref2)))(function(v) {
          return evalM(render3)(ref2)(v["component"]["eval"](new Query2(map26(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
        ...
        var go2 = function(ref2) {
          return function(v1) {
            ...
            if (v1 instanceof Subscribe) {
              return bind14(fresh(SubscriptionId)(ref2))(function(sid) {
                return bind14(liftEffect3(subscribe(v1.value0(sid))(function(act) {
                  ...
                  return bind14(liftEffect3(read(ref2)))(function(v2) {
                    return discard12(liftEffect3(modify_(map27(insert6(sid)(finalize)))(v2.subscriptions)))(function() {
            ...
            if (v1 instanceof Raise) {
              return bind14(liftEffect3(read(ref2)))(function(v2) {
                return bind14(liftEffect3(read(v2.handlerRef)))(function(handler2) {
                ...
                return bind14(liftEffect3(read(ref2)))(function(v2) {
                  return bind14(liftEffect3($$new(false)))(function(doneRef) {
                    return bind14(fork3($$finally(liftEffect3(function __do2() {
                      ...
                      return discard12(liftEffect3(unlessM2(read(doneRef))(modify_(insert12(fid)(fiber))(v2.forks))))(function() {
  ...
  var run3 = function(component3) {
    return function(input4) {
      return function(element4) {
        return bind9(runUI2(component3)(input4)(element4))(function() {
          return pure11(unit);
        });
      };
    };
  ...
  var fromEnum3 = /* @__PURE__ */ fromEnum(boundedEnumSecond);
  var fromEnum1 = /* @__PURE__ */ fromEnum(boundedEnumMinute);
  var mod2 = /* @__PURE__ */ mod(euclideanRingInt);
  var fromEnum22 = /* @__PURE__ */ fromEnum(boundedEnumHour);
  var scalableRecScalableType2 = /* @__PURE__ */ scalableRecScalableType();
  var to2 = /* @__PURE__ */ to()(/* @__PURE__ */ scalableRecScalableType2({
    reflectSymbol: function() {
      return "r";
    }
  })()()(/* @__PURE__ */ scalableRecScalableType2({
    reflectSymbol: function() {
      return "x";
    }
  })()()(/* @__PURE__ */ scalableRecScalableType2({
      ...
      return function(v1) {
        return function(v2) {
          ...
          var getTime = function __do2() {
            ...
            var minute2 = toNumber(fromEnum1(minute(t)));
          ...
          var eta = pi / 2;
          var clock = to2({
            x: v1.scaler.drawing.width / 2,
            y: v1.scaler.drawing.height / 2,
            r: 500
          })(v1.scaler.canvas);
          var drawFrame = function __do2() {
            ...
            setLineWidth(context)(widthTo(25)(v1.scaler.canvas))();
          ...
          var drawHash = function(i2) {
            return function __do2() {
              (function() {
                var $64 = mod2(i2)(5) === 0;
                if ($64) {
                  return setLineWidth(context)(widthTo(9)(v1.scaler.canvas))();
                }
                ;
                return setLineWidth(context)(widthTo(3)(v1.scaler.canvas))();
              })();
          ...
          var drawHashes = function __do2() {
            ...
            return sequence_2(map32(drawHash)(range2(0)(59)))();
          };
          var drawHourHand = function(hour2) {
            return function(minute2) {
              ...
              return function __do2() {
                ...
                setStrokeStyle(context)("black")();
                setLineWidth(context)(widthTo(16)(v1.scaler.canvas))();
                return drawLineSegment(angle)(-0.1)(0.5)();
              };
            };
          };
          var drawMinuteHand = function(minute2) {
            return function(second4) {
              var angle = function(v3) {
                return v3 - eta;
              }(function(v3) {
                return v3 * (tau / 60);
              }(function(v3) {
                return v3 + second4 / 60;
              }(minute2)));
              return function __do2() {
                setLineCap(context)(Round.value)();
                setStrokeStyle(context)("black")();
          ...
          var drawSecondHand = function(second4) {
            var angle = function(v3) {
              return v3 - eta;
            }(function(v3) {
              return v3 * (tau / 60);
            ...
            return function __do2() {
              ...
              setLineWidth(context)(widthTo(7)(v1.scaler.canvas))();
          ...
          return function __do2() {
            ...
            return fillPath(context)(arc(context)({
              ...
              radius: widthTo(15)(v1.scaler.canvas),
              useCounterClockwise: false
            }))();
          };
        };
  ...
  var main2 = /* @__PURE__ */ runGessoAff(/* @__PURE__ */ bind(bindAff)(awaitBody)(function(body2) {
    return run3(component2)(input3)(body2);
  }));
