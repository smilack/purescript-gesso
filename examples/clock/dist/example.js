(() => {
  ...
  var nowTime = /* @__PURE__ */ map(functorEffect)(function($0) {
    return time(toDateTime($0));
  })(now);
    ...
    append: function(v) {
      return function(v1) {
        ...
        if (v instanceof Plain && v1 instanceof Prefixed) {
          return new Prefixed(map(functorArray)(second2(strongFn)(function(v2) {
            return v.value0 + v2;
          }))(v1.value0));
        }
        ;
  ...
  var setLineCap = function(context) {
    return function(v) {
      if (v instanceof Round) {
        return setLineCapImpl(context)("round");
      }
      ;
      if (v instanceof Square) {
        return setLineCapImpl(context)("square");
      }
      ;
      if (v instanceof Butt) {
        return setLineCapImpl(context)("butt");
      }
      ;
      throw new Error("Failed pattern match at Graphics.Canvas (line 238, column 1 - line 238, column 50): " + [context.constructor.name, v.constructor.name]);
    };
  };
  ...
  // output/Example.Clock.Main/index.js
      ...
      return function(v2) {
        return function(context) {
          var getTime = function __do2() {
            var t = nowTime();
            var second3 = toNumber(fromEnum(boundedEnumSecond)(second(t)));
            var minute2 = toNumber(fromEnum(boundedEnumMinute)(minute(t)));
            var hour2 = toNumber(function(v3) {
              return mod(euclideanRingInt)(v3)(12);
            }(function(v3) {
              return v3 + 7 | 0;
            }(fromEnum(boundedEnumHour)(hour(t)))));
            return {
              hour: hour2,
              minute: minute2,
              second: second3
          ...
          var eta = pi / 2;
          var clock = {
            x: v2.x.toCr(getWidth(sizedDimensions)(v2.viewBox) / 2),
            y: v2.y.toCr(getHeight(sizedDimensions)(v2.viewBox) / 2),
            r: v2.width.toCr(500)
          };
          var drawFrame = function __do2() {
            setFillStyle(context)("#eeeeee")();
            fillPath(context)(arc(context)({
              x: clock.x,
              y: clock.y,
              start: 0,
              end: tau,
          ...
          var drawLineSegment = function(angle) {
            return function(r1) {
              return function(r2) {
                var y$prime = clock.y + r2 * clock.r * sin(angle);
                var y = clock.y + r1 * clock.r * sin(angle);
                var x$prime = clock.x + r2 * clock.r * cos(angle);
                var x = clock.x + r1 * clock.r * cos(angle);
                return strokePath(context)(function __do2() {
                  moveTo(context)(x)(y)();
                  return lineTo(context)(x$prime)(y$prime)();
                });
              };
            };
          };
          var drawHash = function(i2) {
            return function __do2() {
              (function() {
                var $22 = mod(euclideanRingInt)(i2)(5) === 0;
                if ($22) {
              ...
              return drawLineSegment(angle)(0.9)(0.95)();
            };
          };
          var drawHashes = function __do2() {
            setStrokeStyle(context)("black")();
            setLineCap(context)(Square.value)();
            return sequence_(applicativeEffect)(foldableArray)(map(functorArray)(drawHash)(range(0)(59)))();
          };
          ...
          var drawMinuteHand = function(minute2) {
          ...
          var drawSecondHand = function(second3) {
            var angle = function(v3) {
              return v3 - eta;
            }(function(v3) {
              return v3 * (tau / 60);
          ...
          var drawNumber = function(i2) {
            var angle = function(v3) {
              return v3 - eta;
            }(function(v3) {
              return v3 * (tau / 12);
            }(toNumber(mod(euclideanRingInt)(i2)(12))));
            var x = clock.x + 0.775 * clock.r * cos(angle);
            var y = clock.y + (0.775 * clock.r * sin(angle) + v2.height.toCr(30));
            return fillText(context)(show(showInt)(i2))(x)(y);
          };
          var drawNumbers = function() {
            var size4 = floor2(v2.width.toCr(78));
            return function __do2() {
              setFillStyle(context)("black")();
              setFont(context)(show(showInt)(size4) + "pt Georgia")();
              setTextAlign(context)(AlignCenter.value)();
              return sequence_(applicativeEffect)(foldableArray)(map(functorArray)(drawNumber)(range(1)(12)))();
            };
          }();
          return function __do2() {
            setFillStyle(context)("white")();
            fillRect(context)(v2.toRectangle(dimensionedDimensions)(v2.screen))();
            drawFrame();
            drawNumbers();
            drawHashes();
            var v3 = getTime();
            drawHourHand(v3.hour)(v3.minute)();
            drawMinuteHand(v3.minute)(v3.second)();
            drawSecondHand(v3.second)();
            setFillStyle(context)("#888888")();
