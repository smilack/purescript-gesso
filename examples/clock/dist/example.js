...
(function($PS) {
  ...
  var runGessoAff = Halogen_Aff_Util.runHalogenAff;
  var run = function (component) {
      return function (input) {
          return function (element) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(component)(input)(element))(function () {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit);
              });
          };
      };
  };
  exports["runGessoAff"] = runGessoAff;
  exports["run"] = run;
})(PS);
(function($PS) {
...
(function($PS) {
  ...
  var p1080 = fromPointAndSize(origin)(fromHeightAndRatio({
      height: 1080.0,
      aspectRatio: Gesso_AspectRatio.w16h9
  }));
...
(function($PS) {
  ...
  var fullscreen = Fullscreen.value;
...
(function($PS) {
  ...
  var setLineCap = function (context) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at Graphics.Canvas (line 237, column 1 - line 237, column 50): " + [ context.constructor.name, v.constructor.name ]);
      };
  };
...
(function($PS) {
  "use strict";
  $PS["Example.Clock.Main"] = $PS["Example.Clock.Main"] || {};
  var exports = $PS["Example.Clock.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Enum = $PS["Data.Enum"];
          ...
          return function (v2) {
              return function (context) {
                  var getTime = function __do() {
                      var t = Effect_Now.nowTime();
                      var second = Data_Int.toNumber(Data_Enum.fromEnum(Data_Time_Component.boundedEnumSecond)(Data_Time.second(t)));
                      var minute = Data_Int.toNumber(Data_Enum.fromEnum(Data_Time_Component.boundedEnumMinute)(Data_Time.minute(t)));
                      var hour = Data_Int.toNumber((function (v3) {
                          return Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(v3)(12);
                      })((function (v3) {
                          return v3 + 7 | 0;
                      })(Data_Enum.fromEnum(Data_Time_Component.boundedEnumHour)(Data_Time.hour(t)))));
                      return {
                          hour: hour,
                          minute: minute,
                          second: second
                  ...
                  var eta = $$Math.pi / 2.0;
                  var clock = {
                      x: v2.x.toCr(Gesso_Dimensions.getWidth(Gesso_Dimensions.sizedDimensions)(v2.viewBox) / 2.0),
                      y: v2.y.toCr(Gesso_Dimensions.getHeight(Gesso_Dimensions.sizedDimensions)(v2.viewBox) / 2.0),
                      r: v2.width.toCr(500.0)
                  };
                  var drawFrame = function __do() {
                      Graphics_Canvas.setFillStyle(context)("#eeeeee")();
                      ...
                      Graphics_Canvas.setStrokeStyle(context)("#888888")();
                      Graphics_Canvas.setLineWidth(context)(v2.width.toCr(25.0))();
                      return Graphics_Canvas.strokePath(context)(Graphics_Canvas.arc(context)({
                          x: clock.x,
                          y: clock.y,
                          start: 0.0,
                          end: $$Math.tau,
                  ...
                  var drawLineSegment = function (angle) {
                      return function (r1) {
                          return function (r2) {
                              var y$prime = clock.y + r2 * clock.r * $$Math.sin(angle);
                              var y = clock.y + r1 * clock.r * $$Math.sin(angle);
                              var x$prime = clock.x + r2 * clock.r * $$Math.cos(angle);
                              var x = clock.x + r1 * clock.r * $$Math.cos(angle);
                              return Graphics_Canvas.strokePath(context)(function __do() {
                                  Graphics_Canvas.moveTo(context)(x)(y)();
                                  return Graphics_Canvas.lineTo(context)(x$prime)(y$prime)();
                              });
                          };
                      };
                  };
                  var drawHash = function (i) {
                      return function __do() {
                          (function () {
                              var $22 = Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i)(5) === 0;
                              if ($22) {
                                  return Graphics_Canvas.setLineWidth(context)(v2.width.toCr(9.0))();
                              };
                              return Graphics_Canvas.setLineWidth(context)(v2.width.toCr(3.0))();
                          })();
                          var angle = (function (v3) {
                              return v3 * ($$Math.tau / 60.0);
                          })(Data_Int.toNumber(i));
                          return drawLineSegment(angle)(0.9)(0.95)();
                      };
                  };
                  var drawHashes = function __do() {
                      Graphics_Canvas.setStrokeStyle(context)("black")();
                      Graphics_Canvas.setLineCap(context)(Graphics_Canvas.Square.value)();
                      return Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(drawHash)(Data_Array.range(0)(59)))();
                  };
                  var drawHourHand = function (hour) {
                      return function (minute) {
                          var angle = (function (v3) {
                              ...
                              return v3 * ($$Math.tau / 12.0);
                          })((function (v3) {
                              return v3 + minute / 60.0;
                          })(hour)));
                          return function __do() {
                              Graphics_Canvas.setLineCap(context)(Graphics_Canvas.Round.value)();
                              Graphics_Canvas.setStrokeStyle(context)("black")();
                              Graphics_Canvas.setLineWidth(context)(v2.width.toCr(16.0))();
                  ...
                  var drawSecondHand = function (second) {
                      ...
                      return function __do() {
                          Graphics_Canvas.setLineCap(context)(Graphics_Canvas.Square.value)();
                          Graphics_Canvas.setStrokeStyle(context)("#DD0000")();
                          Graphics_Canvas.setLineWidth(context)(v2.width.toCr(7.0))();
                  ...
                  var drawNumber = function (i) {
                      var angle = (function (v3) {
                          return v3 - eta;
                      })((function (v3) {
                          return v3 * ($$Math.tau / 12.0);
                      })(Data_Int.toNumber(Data_EuclideanRing.mod(Data_EuclideanRing.euclideanRingInt)(i)(12))));
                      var x = clock.x + 0.775 * clock.r * $$Math.cos(angle);
                    
                      // Graphics.Canvas doesn't have setTextBaseline, so push the numbers down a little
  var y = clock.y + (0.775 * clock.r * $$Math.sin(angle) + v2.height.toCr(30.0));
                      return Graphics_Canvas.fillText(context)(Data_Show.show(Data_Show.showInt)(i))(x)(y);
                  };
                  var drawNumbers = (function () {
                      var size = Data_Int.floor(v2.width.toCr(78.0));
                      return function __do() {
                          Graphics_Canvas.setFillStyle(context)("black")();
                          Graphics_Canvas.setFont(context)(Data_Show.show(Data_Show.showInt)(size) + "pt Georgia")();
                          Graphics_Canvas.setTextAlign(context)(Graphics_Canvas.AlignCenter.value)();
                          return Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(drawNumber)(Data_Array.range(1)(12)))();
                      };
                  })();
                  return function __do() {
                      Graphics_Canvas.setFillStyle(context)("white")();
                      Graphics_Canvas.fillRect(context)(v2.toRectangle(Gesso_Dimensions.dimensionedDimensions)(v2.screen))();
                      drawFrame();
                      drawNumbers();
                      drawHashes();
                      var v3 = getTime();
                      ...
                      Graphics_Canvas.setFillStyle(context)("#888888")();
                      return Graphics_Canvas.fillPath(context)(Graphics_Canvas.arc(context)({
                          x: clock.x,
                          y: clock.y,
                          start: 0.0,
                          end: $$Math.tau,
                          radius: v2.width.toCr(15.0)
                      }))();
                  };
              };
          };
  ...
  var input = {
      name: "test-app",
      localState: Data_Unit.unit,
      app: {
          window: Gesso_Application.fullscreen,
          render: render,
          update: Gesso_Application.defaultApp.update,
          output: Gesso_Application.defaultApp.output,
          input: Gesso_Application.defaultApp.input
      },
      viewBox: Gesso_Dimensions.p1080,
      interactions: Gesso_Interactions["default"]
  };
  var main = Gesso.runGessoAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Gesso.run(Gesso_Canvas.component(Effect_Aff_Class.monadAffAff))(input)(body);
  }));
  exports["main"] = main;
  exports["input"] = input;
  exports["render"] = render;
})(PS);
PS["Example.Clock.Main"].main();