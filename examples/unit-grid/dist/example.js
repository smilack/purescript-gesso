...
(() => {
  ...
  var traversableMaybe = {
    traverse: function(dictApplicative) {
      ...
      return function(v) {
        return function(v1) {
          ...
          ;
          if (v1 instanceof Just) {
            return map32(Just.create)(v(v1.value0));
          }
          ;
    ...
    sequence: function(dictApplicative) {
      ...
      return function(v) {
        ...
        ;
        if (v instanceof Just) {
          return map32(Just.create)(v.value0);
        }
        ;
  ...
  var oneOf2 = function(dictAlternative) {
    ...
    return function(v) {
      return alt5(pure16(v.value0))(v.value1);
    };
  };
      ...
      return function(v) {
        return function(v1) {
          return function(state3) {
            return pure4(new Just(function() {
              var $22 = {};
              ...
              ;
              $22.mousePos = new Just(fromMouseEvent(event));
              return $22;
            }()));
          };
        };
            ...
            return function(app) {
              return function(notify2) {
                var rafCallback = function(timestamp) {
                  ...
                  return function __do2() {
                    var history2 = tryUpdate(scaler)(app.update(delta2))(pure7(stateHistory))();
  ...
  var getFirstFrame = /* @__PURE__ */ requestAnimationFrame3(/* @__PURE__ */ $$const(/* @__PURE__ */ pure7(unit)));
          ...
          return bind13(runMaybeT(bind22(gets2(function(v2) {
            ...
            return bind22(gets2(function(v3) {
              ...
              return lift3(liftEffect7(function __do2() {
                ...
                var stateHistory = foldr4(tryUpdate(v3.scaler))(pure7(initialHistory))(mapFlipped22(updateQueue)(function(v5) {
                  return v5.item;
                }))();
        ...
        return function(v1) {
          ...
          var drawGridLine = function(i2) {
            ...
            return strokePath(context)(function __do2() {
              moveTo(context)(scale3.x.toCr(-n))(scale3.y.toCr(-1))();
              lineTo(context)(scale3.x.toCr(-n))(scale3.y.toCr(1))();
              moveTo(context)(scale3.x.toCr(n))(scale3.y.toCr(-1))();
              lineTo(context)(scale3.x.toCr(n))(scale3.y.toCr(1))();
              moveTo(context)(scale3.x.toCr(-1))(scale3.y.toCr(-n))();
              lineTo(context)(scale3.x.toCr(1))(scale3.y.toCr(-n))();
              moveTo(context)(scale3.x.toCr(-1))(scale3.y.toCr(n))();
              return lineTo(context)(scale3.x.toCr(1))(scale3.y.toCr(n))();
            });
          };
          var drawGridLines = function __do2() {
            setStrokeStyle(context)("black")();
            setLineWidth(context)(scale3.width.toCr(5e-3))();
            return sequence_2(map31(drawGridLine)(range2(1)(10)))();
          };
          var drawCross = function(x) {
            return function(y) {
              return function(length9) {
                return strokePath(context)(function __do2() {
                  moveTo(context)(x - scale3.width.toCr(length9))(y)();
                  lineTo(context)(x + scale3.width.toCr(length9))(y)();
                  moveTo(context)(x)(y - scale3.height.toCr(length9))();
                  return lineTo(context)(x)(y + scale3.height.toCr(length9))();
                });
              };
            };
          };
          var drawMouseClicked = function(mxy) {
            ...
            var text6 = function() {
              ...
              if (mxy instanceof Just) {
                return show4(x$prime(getX3(mxy.value0))) + (", " + (show4(y$prime(getY3(mxy.value0))) + ")"));
              }
              ;
              throw new Error("Failed pattern match at Example.UnitGrid.Main (line 115, column 12 - line 117, column 82): " + [mxy.constructor.name]);
            }();
            var size4 = show1(floor2(scale3.width.toCr(0.2)));
            return function __do2() {
              setFont(context)(size4 + "px 'Courier New'")();
              setFillStyle(context)("black")();
              setTextAlign(context)(AlignCenter.value)();
              fillText(context)("Clicked: (" + text6)(scale3.x.toCr(0))(scale3.y.toCr(-1.1))();
              if (mxy instanceof Nothing) {
                return unit;
              }
              ;
              if (mxy instanceof Just) {
                setStrokeStyle(context)("black")();
                setLineWidth(context)(scale3.width.toCr(0.01))();
                strokePath(context)(arc(context)({
                  x: getX3(mxy.value0),
                  y: getY3(mxy.value0),
                  radius: scale3.width.toCr(0.05),
                  start: 0,
                  end: tau,
                  useCounterClockwise: false
                }))();
                return drawCross(getX3(mxy.value0))(getY3(mxy.value0))(0.05)();
              }
              ;
              throw new Error("Failed pattern match at Example.UnitGrid.Main (line 100, column 5 - line 107, column 51): " + [mxy.constructor.name]);
            };
          };
          var drawMouseCursor = function(point) {
            return function __do2() {
              setStrokeStyle(context)("black")();
              setLineWidth(context)(scale3.width.toCr(0.01))();
              return drawCross(getX3(point))(getY3(point))(0.05)();
            };
          };
          var drawAxes = function __do2() {
            setStrokeStyle(context)("black")();
            setLineWidth(context)(scale3.width.toCr(0.015))();
            return drawCross(scale3.x.toCr(0))(scale3.y.toCr(0))(1)();
          };
          ...
          return function __do2() {
            ...
            drawAxes();
            drawGridLines();
            drawMouseClicked(v1["new"].clicked)();
            return traverse_9(drawMouseCursor)(v1["new"].mousePos)();
          };
        };
      };
    };
  ...
  var mouseDown = /* @__PURE__ */ function() {
    ...
    return new Interaction(onMouseDown, getMousePos);
  }();
