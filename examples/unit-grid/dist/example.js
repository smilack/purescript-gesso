...
(function($PS) {
  ...
  var mousePosition = (function () {
              ...
              return function (v1) {
                  return function (state) {
                      return new Data_Maybe.Just((function () {
                          ...
                          $20.mousePos = Data_Maybe.Just.create(Gesso_Dimensions.fromMouseEvent(event));
                          return $20;
                      })());
                  };
              };
      ...
      return mkInteraction(Halogen_HTML_Events.onMouseMove)(getMousePos);
  })();                                      
  var $$default = {
      base: [  ],
      clipboard: [  ],
...
(function($PS) {
  "use strict";
  $PS["Example.UnitGrid.Main"] = $PS["Example.UnitGrid.Main"] || {};
  var exports = $PS["Example.UnitGrid.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
              ...
              return function (context) {
                  var drawGridLine = function (i) {
                      ...
                      return Graphics_Canvas.strokePath(context)(function __do() {
                          Graphics_Canvas.moveTo(context)(scale.x.toCr(-n))(scale.y.toCr(-1.0))();
                          Graphics_Canvas.lineTo(context)(scale.x.toCr(-n))(scale.y.toCr(1.0))();
                          Graphics_Canvas.moveTo(context)(scale.x.toCr(n))(scale.y.toCr(-1.0))();
                          Graphics_Canvas.lineTo(context)(scale.x.toCr(n))(scale.y.toCr(1.0))();
                          Graphics_Canvas.moveTo(context)(scale.x.toCr(-1.0))(scale.y.toCr(-n))();
                          Graphics_Canvas.lineTo(context)(scale.x.toCr(1.0))(scale.y.toCr(-n))();
                          Graphics_Canvas.moveTo(context)(scale.x.toCr(-1.0))(scale.y.toCr(n))();
                          return Graphics_Canvas.lineTo(context)(scale.x.toCr(1.0))(scale.y.toCr(n))();
                      });
                  };
                  var drawGridLines = function __do() {
                      Graphics_Canvas.setStrokeStyle(context)("black")();
                      Graphics_Canvas.setLineWidth(context)(scale.width.toCr(5.0e-3))();
                      return Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(drawGridLine)(Data_Array.range(1)(10)))();
                  };
                  var drawCross = function (x) {
                      return function (y) {
                          return function (length) {
                              return Graphics_Canvas.strokePath(context)(function __do() {
                                  Graphics_Canvas.moveTo(context)(x - scale.width.toCr(length))(y)();
                                  Graphics_Canvas.lineTo(context)(x + scale.width.toCr(length))(y)();
                                  Graphics_Canvas.moveTo(context)(x)(y - scale.height.toCr(length))();
                                  return Graphics_Canvas.lineTo(context)(x)(y + scale.height.toCr(length))();
                              });
                          };
                      };
                  };
                  var drawMouseClicked = function (mxy) {
                      var y$prime = function ($25) {
                          return (function (v2) {
                              return v2 / 1000.0;
                          })(Data_Int.toNumber(Data_Int.round((function (v2) {
                              return v2 * 1000.0;
                          })(scale.y.toVb($25)))));
                      };
                      ...
                      var text = (function () {
                          if (mxy instanceof Data_Maybe.Nothing) {
                              return "Nothing)";
                          };
                          if (mxy instanceof Data_Maybe.Just) {
                              return Data_Show.show(Data_Show.showNumber)(x$prime(Gesso_Dimensions.getX(Gesso_Dimensions.positionedPoint)(mxy.value0))) + (", " + (Data_Show.show(Data_Show.showNumber)(y$prime(Gesso_Dimensions.getY(Gesso_Dimensions.positionedPoint)(mxy.value0))) + ")"));
                          };
                          throw new Error("Failed pattern match at Example.UnitGrid.Main (line 114, column 12 - line 116, column 82): " + [ mxy.constructor.name ]);
                      })();
                      var size = Data_Show.show(Data_Show.showInt)(Data_Int.floor(scale.width.toCr(0.2)));
                      return function __do() {
                          Graphics_Canvas.setFont(context)(size + "px 'Courier New'")();
                          Graphics_Canvas.setFillStyle(context)("black")();
                          Graphics_Canvas.setTextAlign(context)(Graphics_Canvas.AlignCenter.value)();
                          Graphics_Canvas.fillText(context)("Clicked: (" + text)(scale.x.toCr(0.0))(scale.y.toCr(-1.1))();
                          if (mxy instanceof Data_Maybe.Nothing) {
                              return Data_Unit.unit;
                          };
                          if (mxy instanceof Data_Maybe.Just) {
                              Graphics_Canvas.setStrokeStyle(context)("black")();
                              Graphics_Canvas.setLineWidth(context)(scale.width.toCr(1.0e-2))();
                              Graphics_Canvas.strokePath(context)(Graphics_Canvas.arc(context)({
                                  x: Gesso_Dimensions.getX(Gesso_Dimensions.positionedPoint)(mxy.value0),
                                  y: Gesso_Dimensions.getY(Gesso_Dimensions.positionedPoint)(mxy.value0),
                                  radius: scale.width.toCr(5.0e-2),
                                  start: 0.0,
                                  end: $$Math.tau
                              }))();
                              return drawCross(Gesso_Dimensions.getX(Gesso_Dimensions.positionedPoint)(mxy.value0))(Gesso_Dimensions.getY(Gesso_Dimensions.positionedPoint)(mxy.value0))(5.0e-2)();
                          };
                  ...
                  var drawMouseCursor = function (point) {
                      return function __do() {
                          Graphics_Canvas.setStrokeStyle(context)("black")();
                          Graphics_Canvas.setLineWidth(context)(scale.width.toCr(1.0e-2))();
                          return drawCross(Gesso_Dimensions.getX(Gesso_Dimensions.positionedPoint)(point))(Gesso_Dimensions.getY(Gesso_Dimensions.positionedPoint)(point))(5.0e-2)();
                      };
                  };
                  var drawAxes = function __do() {
                      Graphics_Canvas.setStrokeStyle(context)("black")();
                      Graphics_Canvas.setLineWidth(context)(scale.width.toCr(1.5e-2))();
                      return drawCross(scale.x.toCr(0.0))(scale.y.toCr(0.0))(1.0)();
                  };
                  ...
                  return function __do() {
                      ...
                      return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(drawMouseCursor)(v.mousePos)();
                  };
              };
          };
      };
  ...
  var mouseDown = (function () {
              ...
              return function (v1) {
                  return function (state) {
                      return new Data_Maybe.Just((function () {
                          ...
                          $22.clicked = Data_Maybe.Just.create(Gesso_Dimensions.fromMouseEvent(event));
                          return $22;
                      })());
                  };
              };
      ...
      return Gesso_Interactions.mkInteraction(Halogen_HTML_Events.onMouseDown)(getMousePos);
  })();
  var input = {
      name: "test-app",
      localState: {
          mousePos: Data_Maybe.Nothing.value,
      ...
      viewBox: Gesso_Dimensions.fromPointAndSize(Gesso_Dimensions.fromXAndY({
          x: -1.5,
          y: -1.5
      }))(Gesso_Dimensions.fromWidthAndHeight({
          width: 3.0,
          height: 3.0
      })),
      interactions: {
          ...
          mouse: [ Gesso_Interactions.mousePosition, mouseDown ],
