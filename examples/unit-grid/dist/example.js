                  ...
                  var updateAndRender = function(listener) {
                    return function(delta2) {
                      return function(context) {
                        return function(scaler) {
                          return function __do2() {
                            var v = foldr4(applyUpdate(delta2)(scaler))(pure7(new Tuple(DidNotChange.value, localState)))(new Cons(app.update, queuedUpdates))();
                            (function() {
      ...
      return function(scale2) {
        return function(context) {
          ...
          var drawGridLines = function __do2() {
            ...
            return sequence_2(map26(drawGridLine)(range2(1)(10)))();
          };
